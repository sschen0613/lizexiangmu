...
@Controller
public class StorageOutlibraryOfMaterialClassController {
	@Autowired
	IStorageOutlibraryOfMaterialClassService StorageOutlibraryOfMaterialClassService;

	// 跳转丽泽材料类出库申请界面
	@RequestMapping("storage/outlibraryOfMaterialClass.action")
	public String setupAllocationApproverView1() {
		return "WEB-INF/views/storage/outlibraryOfMaterialClass";
	}
