...
public class OnlineoperationInstalldebugtable {
    private Integer id;
    ...
    private String service_character;

    private String problem_describe;

    private String remark;

    private Integer installDebug_id;
	...
	public String getService_character() {
		return service_character;
	}

	public void setService_character(String service_character) {
	...
	public Integer getInstallDebug_id() {
		return installDebug_id;
	}

	public void setInstallDebug_id(Integer installDebug_id) {
		this.installDebug_id = installDebug_id;
	}
