...
public class FinanceOperationinvoice {
    private Integer lizeInvoice_id;
    ...
    private Date agreementStartStop_date;

    private Date thisInvoiceStartStop_date;

    private String invoice_reason;

    private Integer invoice_if;

    public Integer getLizeinvoiceId() {
        return lizeInvoice_id;
    }

    public void setLizeinvoiceId(Integer lizeInvoice_id) {
        this.lizeInvoice_id = lizeInvoice_id;
    }
    ...
    public Date getAgreementstartstopDate() {
        return agreementStartStop_date;
    }

    public void setAgreementstartstopDate(Date agreementStartStop_date) {
        this.agreementStartStop_date = agreementStartStop_date;
    }

    public Date getThisinvoicestartstopDate() {
        return thisInvoiceStartStop_date;
    }

    public void setThisinvoicestartstopDate(Date thisInvoiceStartStop_date) {
        this.thisInvoiceStartStop_date = thisInvoiceStartStop_date;
    }
