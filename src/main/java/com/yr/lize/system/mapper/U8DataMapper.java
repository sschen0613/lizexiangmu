...
public interface U8DataMapper {
		...
		//查询U8当前的客户合同
		List<HashMap<String, Object>> selectContractForTask(String strContractType);
		...
		Integer insertOtherCMContractCaluseB(HashMap<String,Object> hashMap);
		...
		List<HashMap<String,Object>> selectRdrecord32Info(String cContractID);

    	Integer updateSODetails(String iSOsID, HashMap<String, Object> hashMap);

		List<HashMap<String,Object>> selectOutOrder(String outOrderDate);

		List<HashMap<String,Object>> selectInOrder(String outOrderDate);

		List<HashMap<String,Object>> selectOutInv(String cCode);

		List<HashMap<String,Object>> selectInInv(String cCode);
}
