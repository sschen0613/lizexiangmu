	...
	<body>
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">添加信泽设备维修请购单</button>
			</div>
		</script>
...
// 				});
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=46' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '信泽设备维修请购单'
...
// 						,{field: 'department_name', title: '申请部门', minWidth:100}
						...
						,{field: 'currency_string10', title: '设备名称', minWidth:100}
						,{field: 'currency_date2', title: '故障发生日期', minWidth:120,templet:'<div>{{ Format(d.currency_date,"yyyy-MM-dd")}}</div>'}
						,{field: 'currency_string11', title: '故障描述', minWidth:200}
						,{field: 'currency_string7', title: '申请原因', minWidth:200}
						,{field: 'currency_string13', title: '维修建议厂家', minWidth:150}
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								shadeClose: true,
								area: ['80%', '80%'],
								content: 'xzTesting/equipmentMaintainRequestForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
