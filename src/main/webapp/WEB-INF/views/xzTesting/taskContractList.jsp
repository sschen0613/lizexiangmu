	...
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-block">
				<input type="text" name="currency_string17" placeholder="合同编号 :" autocomplete="off" class="layui-input input-revise">
			</div>
		</div>
		<div class="layui-inline">
...
// 			    	,totalRow: true //开启合计行
			,cols: [[ //表头
				...
				,{field: 'currency_string8', title: '条款名称', minWidth:120}
				,{field: 'currency_string9', title: '条款内容', minWidth:120}
				,{field: 'currency_date2', title: '合同签订日期', minWidth:130, sort: true, templet:'<div>{{ Format(d.currency_date2,"yyyy-MM-dd")}}</div>'}
		...
		table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
			...
			if(layEvent === 'detail'){ //查看
				...
				if(data.currency_int3 != '未领取' && data.currency_int3 != null){
					alert("请勿重复领取！！！");
				}else {
					//向服务端发送删除指令
					$.ajax({
