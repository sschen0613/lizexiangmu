    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="office/mOnlineOperationAndMaintenanceRequestDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=26&approval_id=26'
    				    				 ...
    				    				 +'&currency_date3='+Format(item.currency_date3,"yyyy-MM-dd")+'&currency_string2='+item.currency_string2
