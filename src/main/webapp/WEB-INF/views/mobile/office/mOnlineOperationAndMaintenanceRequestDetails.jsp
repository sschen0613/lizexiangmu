	...
	<body>
		...
		<script type="text/javascript">
            layui.use(['form','element','layer','laydate', 'table' ],function(){
                ...
                var currency_date2 = '${param.currency_date2}'; //开始时间
                var currency_date3 = '${param.currency_date3}'; //结束时间
                var currency_string2 = '${param.currency_string2}'; //调休时长
    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">调休开始时间 :</label>'
							 +				'<input type="text" name="offworkingdays_start" value="'+currency_date2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">调休结束时间:</label>'
							 +				'<input type="text" name="offworkingdays_off" value="'+currency_date3+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">调休时长 :</label>'
							 +				'<input type="text" name="offworkingdays_date" value="'+currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
