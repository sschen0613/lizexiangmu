    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="offworkingdays_start" value="'+Format(item.currency_date3,"yyyy-MM-dd")+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">调休结束时间:</label>'
							 +				'<input type="text" name="offworkingdays_off" value="'+Format(item.currency_date3,"yyyy-MM-dd")+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">调休时长 :</label>'
							 +				'<input type="text" name="offworkingdays_date" value="'+item.currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
