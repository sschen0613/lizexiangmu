    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="office/mCarMaintainRequestDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=33&approval_id=33'
    				    				 ...
    				    				 +'&currency_money6='+item.currency_money6+'&currency_string3='+item.currency_string3+'&currency_string4='+item.currency_string4+'&currency_string5='+item.currency_string5
