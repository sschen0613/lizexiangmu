    			...
    			$.ajax({
    				...
    				success:function(res){
    					...
    					html += '<div class="content-list style">'
                            ...
                            +				'<input type="text" name="currency_string4" value="'+item.currency_string4+'" class="layui-input" readonly>'
                            +			'</div>'
                            +			'<div>'
                            +				'<label class="">是否住宿 :</label>'
                            +				'<input type="text" name="currency_string5" value="'+item.currency_string5+'" class="layui-input" readonly>'
                            +			'</div>'
                            +			'<div>'
                            +				'<label class="">备注 :</label>'
                            +				'<input type="text" name="currency_string7" value="'+item.currency_string7+'" class="layui-input" readonly>'
                            +			'</div>'
							...
							success:function(res){
								...
								$.each(res.data,function(index,item){
									html0+=	'<div class="approval-detail">'
							 		 	 ...
							 		 	 +				'<input name="details_string5" value="'+item.details_string5+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +		'</div>'
							 		 	 +	'</div>';
								});
