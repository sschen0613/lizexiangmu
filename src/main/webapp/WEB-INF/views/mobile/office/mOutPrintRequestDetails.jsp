		...
		<script type="text/javascript">
            layui.use(['form','element','layer','laydate', 'table' ],function(){
    			...
    			$.ajax({
    				...
    				type:'post',
    				data:{'currency_id':currency_id,'currency_string':staffid},
    				dataType:'JSON',
    				beforeSend: function(){
    					layer.load(1);
    		 		},
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">打印地点 :</label>'
							 +				'<input type="text" name="print_point" value="'+currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">打印内容 :</label>'
							 +				'<input type="text" name="print_content" value="'+currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">备注 :</label>'
							 +				'<textarea name="remark" readonly>'+currency_string3+'</textarea>'
							 +			'</div>'
