    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="car_number" value="'+item.currency_string3+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">维修类别 :</label>'
							 +				'<input type="text" name="maintain_type" value="'+item.currency_string4+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">预计金额 :</label>'
							 +				'<input type="text" name="predict_cost" value="'+item.currency_money6+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">维修事由 :</label>'
							 +				'<textarea name="maintain_reason" readonly>'+item.currency_string5+'</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">备注 :</label>'
							 +				'<textarea name="remark" readonly>'+item.currency_string7+'</textarea>'
							 +			'</div>'
