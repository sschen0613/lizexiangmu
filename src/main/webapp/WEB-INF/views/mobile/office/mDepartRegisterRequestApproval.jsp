            ...
            layui.use(['form','element','layer','laydate', 'table' ],function(){
    			...
    			$.ajax({
    				...
    				success:function(res){
                        ...
                        var car_type = item.currency_int2 == "1" ? "公车" : "私家车";
						...
						html += '<div class="content-list style">'
							 ...
							 +			'</div>'
                             +			'<div>'
                             +				'<label class="">出发日期 :</label>'
                             +				'<input type="text" name="out_date" id="date1" value="'+Format(item.currency_date2,"yyyy-MM-dd")+'" class="layui-input" readonly>'
                             +			'</div>'
							 +			'<div>'
							 +				'<label class="">出发地点 :</label>'
							 +				'<input type="text" name="departure_point" value="'+item.currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">目的地 :</label>'
							 +				'<input type="text" name="destination" value="'+item.currency_string3+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">用车类型 :</label>'
							 +				'<input type="text" name="car_type" value="'+car_type +'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">驾驶员 :</label>'
							 +				'<input type="text" name="driver" value="'+item.currency_string4+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">公车车牌号 :</label>'
							 +				'<input type="text" name="publicCar_number" value="'+item.currency_string5+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">私车车牌号 :</label>'
							 +				'<input type="text" name="privateCar_number" value="'+item.currency_string9+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">设备商及人员 :</label>'
							 +				'<input type="text" name="equipmentProducer_person" value="'+item.currency_string8+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
