    				...
    				success:function(res){
    					...
    					html += '<div class="content-list style">'
							 ...
							 +			'</div>'
								...
								+				'<input type="text" name="use_type" value="'+item.currency_string3+'" class="layui-input" readonly>'
								+			'</div>'
								+			'<div>'
								+				'<label class="">费用明细 :</label>'
								+				'<input type="text" name="use_company" value="'+item.currency_string4+'" class="layui-input" readonly>'
								+			'</div>'
								+			'<div>'
