	...
	<body>
		...
		<script type="text/javascript">
            layui.use(['form','element','layer','laydate', 'table' ],function(){
                ...
                var currency_date2 = '${param.currency_date2}'; //出发日期
                ...
                var currency_int2 = '${param.currency_int2}' == '1' ? '公车' : '私家车';
    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
                             ...
                             +				'<input type="text" name="out_date" id="date1" value="'+currency_date2+'" class="layui-input" readonly>'
                             +			'</div>'
							 +			'<div>'
							 +				'<label class="">出发地点 :</label>'
							 +				'<input type="text" name="departure_point" value="'+currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">目的地 :</label>'
							 +				'<input type="text" name="destination" value="'+currency_string3+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">用车类型 :</label>'
							 +				'<input type="text" name="car_type" value="'+ currency_int2 +'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">驾驶员 :</label>'
							 +				'<input type="text" name="driver" value="'+currency_string4+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">公车车牌号 :</label>'
							 +				'<input type="text" name="publicCar_number" value="'+currency_string5+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">私车车牌号 :</label>'
							 +				'<input type="text" name="privateCar_number" value="'+currency_string9+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">设备商及人员 :</label>'
							 +				'<input type="text" name="equipmentProducer_person" value="'+currency_string8+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
