		...
		<div class="container-apply">
			<div class="approval-list-title">
				...
				<span class="menu layui-icon layui-icon-more" onclick="$('.sub-menu').slideToggle();">
					<div class="sub-menu">
						<ul>
							<li onclick="window.location.href = 'office/mOutPrintRequestList.action';">查看申请记录</li>
						</ul>
					</div>
				</span>
			</div>
			<div class="content">
				<form class="layui-form form-apply" action="" method="post">
					...
					<div class="layui-form-item">
						<label class="layui-form-label">打印地点 :</label>
						<div class="layui-input-block">
							<input type="text" id="print_point" name="print_point" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">打印内容 :</label>
						<div class="layui-input-block">
							<input type="text" id="print_content" name="print_content" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
