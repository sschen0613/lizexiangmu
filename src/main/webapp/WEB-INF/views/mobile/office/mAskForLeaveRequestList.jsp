            ...
            success:function(res){
                ...
                $.each(res.data,function(index,item){
                    ...
                    html += '<li>'
                        ...
                        +		'<a href="office/mAskForLeaveRequestDetails.action?currency_id='+item.currency_id
                        +'&current_approvalCount='+item.current_approvalCount
                        +'&approver_count='+item.approver_count
                        +'&approvalOpinion_type=57&approval_id=57'
                        ...
                        +'&currency_string5='+item.currency_string5+'&currency_string7='+item.currency_string7
                        +'&currency_string9='+item.currency_string9+'&currency_string8='+item.currency_string8
                        +'&currency_money6='+item.currency_money6
