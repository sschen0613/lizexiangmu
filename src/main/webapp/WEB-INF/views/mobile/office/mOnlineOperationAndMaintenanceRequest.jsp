	...
	<body>
		<div class="container-apply">
			<div class="approval-list-title">
				...
				<h2 class="">在线运维部调休申请</h2>
				<span class="menu layui-icon layui-icon-more" onclick="$('.sub-menu').slideToggle();">
					<div class="sub-menu">
						<ul>
							<li onclick="window.location.href = 'office/mOnlineOperationAndMaintenanceRequestList.action';">查看申请记录</li>
						</ul>
					</div>
				</span>
			</div>
			<div class="content">
				<form class="layui-form form-apply" action="" method="post">
					...
					<div class="layui-form-item">
						<label class="layui-form-label">调休开始时间 :</label>
						<div class="layui-input-block">
							<input name="starttime" type="text" class="layui-input" id="date1" name="offworkingdays_start" placeholder="请选择日期">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">调休结束时间 :</label>
						<div class="layui-input-block">
							<input name="overtime" type="text" class="layui-input" id="date2" name="offworkingdays_off" placeholder="请选择日期">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">调休时长 :</label>
						<div class="layui-input-block">
							<input type="text" id="offworkingdays_date" name="offworkingdays_date" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
