    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="office/mDepartRegisterRequestDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=21&approval_id=21'
    				    				 ...
    				    				 +'&currency_string7='+item.currency_string7+'&currency_string8='+item.currency_string8+'&currency_string9='+item.currency_string9+'&currency_date2='+Format(item.currency_date2,"yyyy-MM-dd")
										 +'currency_int2='+item.currency_int2
