    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="office/mTravelRegistrationRequestDetails.action?currency_id='+item.currency_id
    				    				 ...
    				    				 +'&staff_name='+item.staff_name+'&currency_date='+Format(item.currency_date,"yyyy-MM-dd")
                                		 +'&currency_string4='+item.currency_string4
                                		 +'&currency_string5='+item.currency_string5
