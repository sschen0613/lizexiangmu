    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="finance/mInvoiceOfSalesContractDetails.action?currency_id='+item.currency_id
    				    				 ...
    				    				 +'&currency_string12='+item.currency_string12+'&currency_string13='+item.currency_string13+'&currency_int5='+item.currency_int5+'&currency_string14='+item.currency_string15+'&currency_string15='+item.currency_string16+'&currency_string14='+item.currency_string16+'&currency_int6='+item.currency_int6
