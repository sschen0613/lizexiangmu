	...
	<body>
		<div class="container-apply">
			<div class="approval-list-title">
				...
				<h2 class="">信泽公司检测合同发票开具申请</h2>
				<span class="menu layui-icon layui-icon-more" onclick="$('.sub-menu').slideToggle();">
					<div class="sub-menu">
						<ul>
							<li onclick="window.location.href = 'finance/mInvoiceOfInspectionContractList.action';">查看申请记录</li>
						</ul>
					</div>
				</span>
			</div>
			<div class="content">
				<form class="layui-form form-apply" action="" method="post">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="invoice_name" id="invoice_name" class="layui-input" >
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">税号 :</label>
						<div class="layui-input-block">
							<input type="text" name="tax_number" id="tax_number" class="layui-input" >
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">地址 :</label>
						<div class="layui-input-block">
							<input type="text" name="site" id="site" class="layui-input" >
						</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="alreadyInvoice_amount" id="alreadyInvoice_amount" class="layui-input" readonly>
						</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<select name="cost_type"><option value="1">检测费</option><option value="2">技术服务费</option></select>
						</div>
					</div>
					<div class="layui-form-item">
...
// 				form.render('radio');
				...
				//监听提交按钮
              	form.on('submit(submitForm)', function(data){
                    ...
                    //var contract = data.field.contract;
                ...
                form.on('select(customer_name)', function(data){
                    ...
                    $.ajax({
                        ...
                        success:function(res){
                            ...
                            $.each(res.data,function(index,item){
                                html += '<option value="'+item.strContractID+'" data-name="'+item.strContractName+'"  data-moneyBegin="'+item.cDefine14+'" data-invoiceBegin="'+item.cDefine11+'" data-invoiceAlready="'+item.cDefine13+'" data-money="'+item.dblTotalCurrency+'" >名称：'+item.strContractName
