	...
	<body>
		...
		<script type="text/javascript">
            layui.use(['form','element','layer','laydate', 'table' ],function(){
                ...
                var currency_string15= '${param.currency_string15}';
    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<input name="invoice_type" value="'+(currency_int5==1?"普通发票":"专用发票")+'" class="layui-input" readonly>'
							 +			'</div>'
                            +			'<div>'
                            ...
                            +			'</div>'
							 ...
							 +				'<input name="agreementStartStop_date_start" value="'+currency_date2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="" style="width: 66%;">运营合同结束日期 :</label>'
							 +				'<input name="agreementStartStop_date_end" value="'+currency_date3+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="" style="width: 66%;">本次开票开始日期 :</label>'
							 +				'<input name="thisInvoiceStartStop_date_start" value="'+currency_date4+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="" style="width: 66%;">本次开票结束日期 :</label>'
							 +				'<input name="thisInvoiceStartStop_date_end" value="'+currency_date5+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
