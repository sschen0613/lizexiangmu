	...
	<body>
		...
		<script type="text/javascript">
            layui.use(['form','element','layer','laydate', 'table' ],function(){
                ...
                var currency_int4 = '${param.currency_int4}';
    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="" style="width: 40%;">开户行及账号 :</label>'
							 +				'<input type="text" name="bankAndAccount" value="'+currency_string10+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="" style="width: 40%;">合同付款约定 :</label>'
							 +				'<textarea id="contract" name="contract" value="'+currency_string11+'" class="layui-textarea" readonly></textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">合同总金额 :</label>'
							 +				'<input type="text" id="contract_amount" value="'+currency_money+'" name="contract_amount" value="'+currency_money+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">实际收款 :</label>'
							 +				'<input type="text" id="actual_receipt" name="actual_receipt" value="'+currency_money2+'" value="'+currency_money2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 ...
							 +				'<input name="invoice_type" value="'+(currency_int3==1?"普通发票":"专用发票")+'" class="layui-input" readonly>'
							 +			'</div>'
                            +			'<div>'
                            ...
                            +			'</div>'
							 +			'<div>'
							 +				'<label class="">费用类型 :</label>'
							 +				'<input name="cost_type" value="'+(currency_int4==1?"检测费":"技术服务费")+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 ...
							 +				'<input name="invoice_if" value="'+(currency_int6==1?"是":"否")+'" class="layui-input" readonly>'
							 +			'</div>'
