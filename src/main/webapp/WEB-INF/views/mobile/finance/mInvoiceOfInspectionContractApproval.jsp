                        ...
                        $.ajax({
                            ...
                            success:function(result) {
                                ...
                                html += '<div class="content-list style">'
                                    ...
                                    +				'<input name="invoice_type" class="layui-input" value="'+(item.currency_int3==1?"普通发票":"专用发票")+'" readonly>'
                                    +			'</div>'
                                    +			'<div>'
                                    ...
                                    +				'<input name="cost_type" class="layui-input" value="'+(item.currency_int4==1?"检测费":"技术服务费")+'" readonly>'
                                    +			'</div>'
                                    +			'<div>'
                                    +				'<label class="">开票事由 :</label>'
                                    +				'<input name="invoice_reason" class="layui-input" value="'+item.currency_string14+'" readonly>'
                                    +			'</div>'
                                    +			'<div>'
                                    +				'<label class="" style="width: 66%;">开票信息是否一致 :</label>'
                                    +				'<input name="invoice_if" class="layui-input" value="'+(item.currency_int6==1?"是":"否")+'" readonly>'
                                    +			'</div>'
