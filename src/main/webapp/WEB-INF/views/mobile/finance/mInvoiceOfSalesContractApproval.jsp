                        ...
                        $.ajax({
                            ...
                            success:function(result) {
                                ...
                                html += '<div class="content-list style">'
                                    ...
                                    +				'<input type="text" id="contract_id" value="'+item.currency_string4+'" class="layui-input" readonly>'
                                    +			'</div>'
                                    +			'<div>'
                                    ...
                                    +				'<textarea id="contract" name="account" value="'+item.currency_string11+'" class="layui-textarea" readonly></textarea>'
                                    +			'</div>'
                                    +			'<div>'
