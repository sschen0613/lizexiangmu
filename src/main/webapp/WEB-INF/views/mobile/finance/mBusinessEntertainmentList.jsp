    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="finance/mBusinessEntertainmentDetails.action?currency_id='+item.currency_id
    				    				 ...
    				    				 +'&currency_string4='+item.currency_string4+'&currency_string5='+item.currency_string5+'&currency_string8='+item.currency_string8
    				    				 +'&currency_int6='+item.currency_int6+'&currency_money6='+item.currency_money6
    				    				 +'&currency_string7='+item.currency_string7+'&currency_date2='+Format(item.currency_date2,"yyyy-MM-dd")
