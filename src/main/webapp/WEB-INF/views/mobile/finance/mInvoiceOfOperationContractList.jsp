    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="finance/mInvoiceOfOperationContractDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=23&approval_id=23'
    				    				 ...
    				    				 +'&currency_date3='+Format(item.currency_date3,"yyyy-MM-dd")+'&currency_date4='+Format(item.currency_date4,"yyyy-MM-dd")+'&currency_date5='+Format(item.currency_date5,"yyyy-MM-dd")
    				    				 +'&currency_string2='+item.currency_string2+'&currency_string3='+item.currency_string3+'&currency_string4='+item.currency_string4+'&currency_string5='+item.currency_string5
    				    				 +'&currency_string7='+item.currency_string7+'&currency_string8='+item.currency_string8+'&currency_string9='+item.currency_string9+'&currency_string10='+item.currency_string10+'&currency_string11='+item.currency_string11
    				    				 +'&currency_string13='+item.currency_string13+'&currency_string14='+item.currency_string14+'&currency_string12='+item.currency_string12
    				    				 +'&currency_money='+item.currency_money+'&currency_money2='+item.currency_money2+'&currency_money3='+item.currency_money3
    				    				 +'&currency_int5='+item.currency_int5+'&currency_int6='+item.currency_int6
