    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="finance/mInvoiceOfInspectionContractDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=29&approval_id=29'
    				    				 ...
    				    				 +'&currency_string2='+item.currency_string2+'&currency_string='+item.currency_string3+'&currency_string4='+item.currency_string4+'&currency_string5='+item.currency_string5
    				    				 +'&currency_string7='+item.currency_string7+'&currency_string8='+item.currency_string8+'&currency_string9='+item.currency_string9+'&currency_string10='+item.currency_string10
    				    				 +'&currency_string11='+item.currency_string11+'&currency_string12='+item.currency_string12+'&currency_string13='+item.currency_string13+'&currency_string14='+item.currency_string14+item.currency_string15+'&currency_string15='+item.currency_string16
    				    				 +'&currency_money='+item.currency_money+'&currency_money2='+item.currency_money2+'&currency_money3='+item.currency_money3
    				    				 +'&currency_int3='+item.currency_int3+'&currency_int4='+item.currency_int4+'&currency_int6='+item.currency_int6
