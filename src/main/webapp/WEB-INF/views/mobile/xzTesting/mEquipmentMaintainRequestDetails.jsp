	...
	<body>
		...
		<script type="text/javascript">
            layui.use(['form','element','layer','laydate', 'table' ],function(){
                ...
                var currency_string10 = '${param.currency_strin10}';
    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="parts_name" value="'+currency_string10+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="" style="width:40%;">故障发生日期 :</label>'
							 +				'<input type="text" name="start_date" value="'+currency_date2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">故障描述 :</label>'
							 +				'<textarea name="breakdown_describe" value="" readonly class="layui-textarea">'+currency_string11+'</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">申请原因 :</label>'
							 +				'<textarea name="proposer_reason" value="" readonly class="layui-textarea">'+currency_string7+'</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="" style="width:40%;">维修建议厂家 :</label>'
							 +				'<textarea name="suggest" value="" readonly class="layui-textarea">'+currency_string13+'</textarea>'
							 +			'</div>'
