        ...
        $.ajax({
            ...
            success:function(res){
                ...
                html += '<div class="content-list style">'
                    ...
                    +				'<input type="text" name="contract_number" value="'+item.currency_string18+'" class="layui-input" readonly>'
                    +			'</div>'
					+			'<div>'
					+				'<label class="">合同状态 :</label>'
					+				'<input type="text" name="currency_string16" value="'+item.currency_string16+'" class="layui-input" readonly>'
					+			'</div>'
                    +			'<div>'
                    ...
                    +				'<input type="text" name="remark" value="'+item.currency_string9+'" class="layui-input" readonly>'
                    +			'</div>'
                    ...
                    success:function(res){
                        ...
                        $.each(res.data,function(index,item){
                            html0+=	'<div class="approval-detail">'
                                ...
                                +		'<div class="details">'
                                +			'<div>'
                                +				'<label class="">检测项目类别 :</label> '
                                +				'<input type="text" name="" value="'+item.details_string+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
                                +				'<label class="">检测项目个数 :</label>'
                                +				'<input type="text" name="" value="'+item.details_money3+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
                                +				'<label class="">点位个数 :</label>'
                                +				'<input type="text" name="" value="'+item.details_money5+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
