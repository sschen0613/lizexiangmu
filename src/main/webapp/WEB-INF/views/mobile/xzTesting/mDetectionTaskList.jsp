    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="xzTesting/mDetectionTaskDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=51&approval_id=51'
    				    				 ...
    				    				 +'&currency_string2='+item.currency_string2+'&currency_string3='+item.currency_string3+'&currency_string4='+item.currency_string4+'&currency_string5='+item.currency_string5+'&currency_string7='+item.currency_string7+'&currency_string8='+item.currency_string8
