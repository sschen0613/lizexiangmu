    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="xzTesting/mEquipmentMaintainRequestDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=46&approval_id=46'
    				    				 ...
    				    				 +'&currency_string10='+item.currency_string10+'&currency_date2='+Format(item.currency_date2,"yyyy-MM-dd")+'&currency_string11='+item.currency_string11+'&currency_string7='+item.currency_string7+'&currency_string13='+item.currency_string13
