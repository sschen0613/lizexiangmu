    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="accompanying_person" value="'+currency_string3+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">合同总金额 :</label>'
							 +				'<input name="applied_amount" value="'+currency_string10+'" class="layui-input" readonly>'
							 +			'</div>'
                            +			'<div>'
                            +				'<label class="">已收/付金额 :</label>'
                            +				'<input name="applied_amount" value="'+currency_string11+'" class="layui-input" readonly>'
                            +			'</div>'
                            +			'<div>'
