    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="contract/mOperationServiceContractSealDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=35&approval_id=35'
    				    				 ...
    				    				 +'&currency_string2='+item.currency_string2+'&currency_string5='+item.currency_string5+'&currency_string15='+item.currency_string15
