    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="contract/mLzTechnicalServiceContractSealDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=36&approval_id=36'
                                ...
                                +'&currency_string2='+item.currency_string2+'&currency_string5='+item.currency_string5+'&currency_string18='+item.currency_string18
                                +'&currency_string12='+item.currency_string12+'&currency_string13='+item.currency_string13+'&currency_string8='+item.currency_string8
                                +'&currency_string9='+item.currency_string9+'&currency_string10='+item.currency_string10+'&currency_string11='+item.currency_string11
                                +'&currency_money='+item.currency_money+'&currency_int6='+item.currency_int6+'&currency_date2='+Format(item.currency_date2,"yyyy-MM-dd")
                                +'&currency_string7='+item.currency_string7+'&currency_string3='+item.currency_string3
