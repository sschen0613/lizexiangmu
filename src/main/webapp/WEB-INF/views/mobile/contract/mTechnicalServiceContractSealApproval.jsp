    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<textarea type="text" name="remark_illustration" value="'+item.currency_string+'" class="layui-textarea" readonly>无档案的客户名称请填写《客户档案建档申请流程》</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">业务人员 :</label>'
							 +				'<input type="text" id="person" name="person" value="'+item.currency_string10+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">服务类型 :</label>'
							 +				'<input type="text" name="service_type" value="'+(item.currency_int2==1?"一次性服务":"按合同期间")+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">合同期间 :</label>'
							 +				'<input type="text" name="time-ranges" value="'+item.currency_string14+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 ...
							 +				'<input type="text" name="payment" value="'+(item.currency_int6 == "1" ? "一次性付清" :item.currency_int6 == "2" ? "阶段付款":"其他")+'" class="layui-input" readonly>'
							 +			'</div>'
