    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							...
							+				'<input type="text" name="contractType" value="'+item.currency_string4+'" class="layui-input" readonly>'
							+			'</div>'
							 +			'<div>'
							 +				'<label class="">签约单位 :</label>'
							 +				'<input type="text" id="customer_unit" name="customer_unit" value="'+item.currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">签约内容 :</label>'
							 +				'<input type="text" name="accompanying_person" value="'+item.currency_string3+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">合同总金额 :</label>'
							 +				'<input type="text" name="applied_amount" value="'+item.currency_string10+'" class="layui-input" readonly>'
							 +			'</div>'
                            +			'<div>'
                            +				'<label class="">已收/付金额 :</label>'
                            +				'<input type="text" name="applied_amount" value="'+item.currency_string11+'" class="layui-input" readonly>'
                            +			'</div>'
                            +			'<div>'
