	...
	<body>
		...
		<script type="text/javascript">
            layui.use(['form','element','layer','laydate', 'table' ],function(){
                ...
                var currency_string = '${param.currency_string}'; //申请事由
                ...
                var currency_string14 = '${param.currency_string14}'; //合同期间
                var currency_int6 = '${param.currency_int6}'; //支付方式
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							...
							/* +			'<div>'
							 ...
							 +				'<textarea type="text" name="partsSpecial_terms" class="layui-textarea" readonly>'+currency_string+'</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="" style="width: 40%;">检测比对约定 :</label>'
							 +				'<textarea type="text" name="detection_icrms" class="layui-textarea" readonly>'+currency_string15+'</textarea>'
							 +			'</div>'
							 +			'<div>'
