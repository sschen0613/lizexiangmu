						...
						success:function(res){
							...
							$.each(res.data,function(index,item){
								...
								var html = ''
										...
										+			'<div class="layui-input-block">'
										+				'<textarea name="contract_str_name" class="layui-textarea" readonly>'+item.strName+'</textarea>'
										+			'</div>'
										+		'</div>'
										...
										+			'<div class="layui-input-block">'
										+				'<textarea name="contract_str_name_change" class="layui-textarea"></textarea>'
										+			'</div>'
										+		'</div>'
										...
										+			'<div class="layui-input-block">'
										+				'<textarea name="contract_str_memo" class="layui-textarea" readonly>'+item.strMemo+'</textarea>'
										+			'</div>'
										+		'</div>'
										...
										+			'<div class="layui-input-block">'
										+				'<textarea name="contract_str_memo_change" class="layui-textarea"></textarea>'
										+			'</div>'
										+		'</div>'
