    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="contract/mTechnicalServiceContractSealDetails.action?currency_id='+item.currency_id
    				    				 ...
    				    				 +'&approvalOpinion_type=47&approval_id=47'
    				    				 ...
    				    				 +'&currency_string2='+item.currency_string2+'&currency_string5='+item.currency_string5+'&currency_string7='+item.currency_string7+'&currency_string4='+item.currency_string4
    				    				 +'&currency_string8='+item.currency_string8+'&currency_string9='+item.currency_string9+'&currency_string10='+item.currency_string10+'&currency_string11='+item.currency_string11+'&currency_string13='+item.currency_string13+'&currency_string14='+item.currency_string14+'&currency_string18='+item.currency_string18+'&currency_string='+item.currency_string
    				    				 +'&currency_money='+item.currency_money
    				    				 +'&currency_int2='+item.currency_int2+'&currency_int6='+item.currency_int6+'&currency_date2='+Format(item.currency_date2,"yyyy-MM-dd")+'&currency_date3='+Format(item.currency_date3,"yyyy-MM-dd")+'&currency_date4='+Format(item.currency_date4,"yyyy-MM-dd")
