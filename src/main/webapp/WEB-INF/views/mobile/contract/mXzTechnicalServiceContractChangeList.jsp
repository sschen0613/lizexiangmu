    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="contract/mTechnicalServiceContractSealDetails.action?currency_id='+item.currency_id
										 ...
										 +'&currency_string7='+item.currency_string7+'&currency_string4='+item.currency_string4
    				    				 +'&currency_string8='+item.currency_string8+'&currency_string9='+item.currency_string9
										 +'&currency_string3='+item.currency_string3+'&currency_string='+item.currency_string
    				    				 +'&currency_money='+item.currency_money+'&currency_money2='+item.currency_money2
