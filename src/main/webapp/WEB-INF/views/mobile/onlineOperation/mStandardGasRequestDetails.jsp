        ...
        $.ajax({
            ...
            success:function(res){
                ...
                html += '<div class="content-list style">'
                    ...
                    +				'<input type="text" name="area" id="area" value="'+currency_string10+'" class="layui-input" readonly>'
                    +			'</div>'
                    +			'<div>'
                    +				'<label class="">需求日期 :</label>'
                    +				'<input type="text" name="require_date" id="require_date" value="'+currency_date2+'" class="layui-input" readonly>'
                    +			'</div>'
                    ...
                    success:function(res){
                        ...
                        $.each(res.data,function(index,item){
                            html0+=	'<div class="approval-detail">'
                                ...
                                +				'<input type="text" name="area" value="'+item.details_string8+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
                                +				'<label class="">企业站点名称 :</label>'
                                +				'<input type="text" name="enterprise" value="'+item.details_string5+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
                                +				'<label class="">标气类型 :</label>'
                                +				'<input type="text" name="standard_type" value="'+item.details_string9+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
                                +				'<label class="">浓度 :</label>'
                                +				'<input type="text" name="potency" value="'+item.details_string10+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
                                ...
                                +				'<input type="text" name="quantity" value="'+item.details_money+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
