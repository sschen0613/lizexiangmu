    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<textarea class="layui-textarea" name="breakdown_describe" readonly>'+item.currency_string4+'</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">申请原因 :</label>'
							 +				'<textarea class="layui-textarea" name="proposer_for" readonly>'+item.currency_string5+'</textarea>'
							 +			'</div>'
