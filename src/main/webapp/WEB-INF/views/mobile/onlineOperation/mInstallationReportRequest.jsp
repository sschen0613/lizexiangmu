		...
		<div class="container-apply">
			<div class="approval-list-title">
				...
				<span class="menu layui-icon layui-icon-more" onclick="$('.sub-menu').slideToggle();">
					<div class="sub-menu">
						<ul>
							<li onclick="window.location.href = 'onlineOperation/mInstallationReportRequestList.action';">查看申请记录</li>
						</ul>
					</div>
				</span>
			</div>
						...
						<div class="apply-detail">
							...
							<div class="details">
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<select name="enterprise" id="enterprise1" lay-filter="enterprise" lay-search lay-verify="required"></select>
									</div>
								</div>
								<div class="layui-form-item">
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" name="service_character" class="layui-input">
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label">问题描述 :</label>
									<div class="layui-input-block">
										<input type="text" name="problem_describe" class="layui-input">
									</div>
								</div>
								<div class="layui-form-item">
...
// 				form.render('radio');
				...
				//监听提交按钮
              	form.on('submit(submitForm)', function(data){
					...
					$.each($('.details'),function(index,item){
                        ...
                        var problem_describe = $(item).find('input[name="problem_describe"]').val();
                        var remark = $(item).find('input[name="remark"]').val();

                        var obj = {'details_string2':enterprise,'details_string5':equipment_name,'details_string6':specifications_models
                ...
                $('.addDetails').click(function(){
                  ...
                  var html = ''
					...
					+			'<label class="layui-form-label">企业名称 :</label>'
					+			'<div class="layui-input-block">'
					+				'<select name="enterprise" id="enterprise'+d_count+'" lay-filter="enterprise" lay-search lay-verify="required">'+enterprise_name_html+'</select>'
					+			'</div>'
					+		'</div>'
					+		'<div class="layui-form-item">'
					+			'<label class="layui-form-label">设备名称 :</label>'
					+			'<div class="layui-input-block">'
					+				'<input type="text" name="equipment_name" class="layui-input" readonly>'
					+			'</div>'
					+		'</div>'
					+		'<div class="layui-form-item">'
					+			'<label class="layui-form-label">规格型号 :</label>'
					...
					+			'<label class="layui-form-label">服务性质 :</label>'
					+			'<div class="layui-input-block">'
					+				'<input type="text" name="service_character" class="layui-input" readonly>'
					+			'</div>'
					+		'</div>'
					+		'<div class="layui-form-item">'
					+			'<label class="layui-form-label">问题描述 :</label>'
					+			'<div class="layui-input-block">'
					+				'<input type="text" name="problem_describe" class="layui-input" readonly>'
					+			'</div>'
					+		'</div>'
					+		'<div class="layui-form-item">'
					+			'<label class="layui-form-label">备注 :</label>'
