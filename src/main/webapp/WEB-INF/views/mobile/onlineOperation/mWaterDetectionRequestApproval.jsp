    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
                            ...
                            +				'<input type="text" name="area" value="'+item.currency_string2+'" readonly>'
                            +			'</div>'
                            +			'<div>'
                            +				'<label class="">企业名称 :</label>'
                            +				'<input type="text" name="company_name" value="'+item.currency_string7+'" readonly>'
                            +			'</div>'
                            +			'<div>'
                            +				'<label class="">采样日期 :</label>'
                            +				'<input type="text" name="currency_date4" id="date4" value="'+Format(item.currency_date4,"yyyy-MM-dd")+'" class="layui-input" readonly>'
                            +			'</div>'
                            +			'<div>'
                            +				'<label class="">计划检测日期 :</label>'
                            +				'<input type="text" name="currency_date2" id="date2" value="'+Format(item.currency_date2,"yyyy-MM-dd")+'" class="layui-input" readonly>'
                            +			'</div>'
                            +			'<div>'
                            +				'<label class="">计划完成日期 :</label>'
                            +				'<input type="text" name="currency_date3" id="date3" value="'+Format(item.currency_date3,"yyyy-MM-dd")+'" class="layui-input" readonly>'
                            +			'</div>'
