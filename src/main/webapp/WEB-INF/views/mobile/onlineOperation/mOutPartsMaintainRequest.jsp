	...
	<body>
		<div class="container-apply">
			<div class="approval-list-title">
				...
				<h2 class="">外部维修及售后申请</h2>
				<span class="menu layui-icon layui-icon-more" onclick="$('.sub-menu').slideToggle();">
					<div class="sub-menu">
						<ul>
							<li onclick="window.location.href = 'onlineOperation/mOutPartsMaintainRequestList.action';">查看申请记录</li>
						</ul>
					</div>
				</span>
			</div>
				...
				<form class="layui-form form-apply" action="" method="post">
					...
					<div class="layui-form-item">
 					...
 					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<textarea class="layui-textarea" name="breakdown_describe" placeholder="请务必描述故障" lay-verify="required"></textarea>
						</div>
 					</div>
 					<div class="layui-form-item">
						<label class="layui-form-label">申请原因 :</label>
						<div class="layui-input-block">
							<textarea class="layui-textarea" name="proposer_for"></textarea>
						</div>
 					</div>
					<!-- 明细信息 -->
...
// 				form.render('radio');
                ...
                $('.addDetails').click(function(){
                  ...
                  var html = ''
					...
					+			'<label class="layui-form-label">配件名称 :</label>'
					+			'<div class="layui-input-block">'
					+				'<input type="text" name="parts_name" class="layui-input" readonly>'
					+			'</div>'
					+		'</div>'
					+		'<div class="layui-form-item">'
					+			'<label class="layui-form-label">规格型号 :</label>'
