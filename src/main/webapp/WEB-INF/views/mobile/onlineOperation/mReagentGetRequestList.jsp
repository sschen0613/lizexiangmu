    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="onlineOperation/mReagentGetRequestDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=22&approval_id=22'
    				    				 ...
    				    				 +'&currency_string10='+item.currency_string10+'&currency_date2='+Format(item.currency_date2,"yyyy-MM-dd")
