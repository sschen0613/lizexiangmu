    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="operation_person" id="operation_person" value="'+item.currency_string3+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">站点名称 :</label>'
							 +				'<input type="text" name="site_name" id="site_name" value="'+item.currency_string4+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">剔除项目 :</label>'
							 +				'<input type="text" name="equipment_type" id="equipment_type" value="'+item.currency_string8+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">责任部门 :</label>'
							 +				'<input type="text" name="duty_department" id="duty_department" value="'+item.currency_string9+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">异常时间段 :</label>'
							 +				'<input type="text" name="abnormity_date" id="abnormity_date" value="'+item.currency_string5+'" class="layui-input" readonly>'
							 +			'</div>'
                             +			'<div>'
                            ...
                            +				'<input type="text" name="remark" id="remark" value="'+item.currency_string10+'" class="layui-input" readonly>'
                            +			'</div>'
