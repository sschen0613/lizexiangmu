    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">申请单位 :</label>'
							 +				'<input type="text" name="proposer_unit" value="'+item.currency_string4+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">请购区域 :</label>'
							 +				'<input type="text" name="buy_area" value="'+item.currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">需求日期 :</label>'
							 +				'<input type="text" name="demand_date" value="'+Format(item.currency_date2,"yyyy-MM-dd")+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">申请事由 :</label>'
							 +				'<textarea class="layui-textarea" name="proposer_reason" readonly>'+item.currency_string7+'</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">技术要求 :</label>'
							 +				'<textarea class="layui-textarea" name="technology_require" readonly>'+item.currency_string5+'</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">其它说明 :</label>'
							 +				'<textarea class="layui-textarea" name="else_explain" readonly>'+item.currency_string8+'</textarea>'
							 +			'</div>'
							...
							success:function(res){
								...
								$.each(res.data,function(index,item){
									html0+=	'<div class="approval-detail">'
							 		 	 ...
							 		 	 +				'<input id="product_name" name="product_name" value="'+item.details_string2+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 ...
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">适用企业 :</label>'
							 		 	 +				'<input type="text" name="apply_firm" value="'+item.details_string8+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">备注 :</label>'
