    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							...
							+				'<input type="text" name="currency_string5" id="currency_string5" value="'+item.currency_string5+'" class="layui-input" readonly>'
							+			'</div>'
							 +			'<div>'
							 +				'<label class="">站点名称 :</label>'
							 +				'<input type="text" name="detection_program" id="detection_program" value="'+item.currency_string9+'" class="layui-input" readonly>'
							 +			'</div>'
							+			'<div>'
