    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">运维人 :</label>'
							 +				'<input type="text" name="operation_person" id="operation_person" value="'+currency_string3+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">站点名称 :</label>'
							 +				'<input type="text" name="site_name" id="site_name" value="'+currency_string4+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">剔除项目 :</label>'
							 +				'<input type="text" name="equipment_type" id="equipment_type" value="'+currency_string8+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">责任部门 :</label>'
							 +				'<input type="text" name="duty_department" id="duty_department" value="'+currency_string9+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">异常时间段 :</label>'
							 +				'<input type="text" name="abnormity_date" id="abnormity_date" value="'+currency_string5+'" class="layui-input" readonly>'
							 +			'</div>'
                             +			'<div>'
                             +				'<label class="">异常情况描述 :</label>'
                             +				'<input type="text" name="abnormity_describe" id="abnormity_describe" value="'+currency_string7+'" class="layui-input" readonly>'
                             +			'</div>'
                            +			'<div>'
                            +				'<label class="">备注 :</label>'
                            +				'<input type="text" name="remark" id="remark" value="'+currency_string10+'" class="layui-input" readonly>'
                            +			'</div>'
