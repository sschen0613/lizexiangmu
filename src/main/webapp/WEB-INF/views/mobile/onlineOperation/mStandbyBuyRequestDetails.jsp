    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="proposer_unit" value="'+currency_string4+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">请购区域 :</label>'
							 +				'<input type="text" name="buy_area" value="'+currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">需求日期 :</label>'
							 +				'<input type="text" name="demand_date" value="'+currency_date2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">申请事由 :</label>'
							 +				'<textarea class="layui-textarea" name="proposer_reason" readonly>'+currency_string7+'</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">技术要求 :</label>'
							 +				'<textarea class="layui-textarea" name="technology_require" readonly>'+currency_string5+'</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">其它说明 :</label>'
							 +				'<textarea class="layui-textarea" name="else_explain" readonly>'+currency_string8+'</textarea>'
							 +			'</div>'
