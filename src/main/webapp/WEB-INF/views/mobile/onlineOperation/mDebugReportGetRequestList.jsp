    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="onlineOperation/mDebugReportGetRequestDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=37&approval_id=37'
    				    				 ...
    				    				 +'&currency_string7='+item.currency_string7+'&currency_string11='+item.currency_string11+'&currency_string12='+item.currency_string12
