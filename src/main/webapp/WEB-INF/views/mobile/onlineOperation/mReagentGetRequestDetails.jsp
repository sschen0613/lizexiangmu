    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="proposer_type" id="proposer_type" value="'+currency_string10+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
								...
								$.each(res.data,function(index,item){
									html0+=	'<div class="approval-detail">'
                                         ...
                                         +			'</div>'
							 		 	 ...
							 		 	 +				'<input type="text" name="enterprise" value="'+item.details_string9+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
                                         +			'<div>'
