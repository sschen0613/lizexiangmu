		...
		<div class="container-apply">
			<div class="approval-list-title">
				...
				<span class="menu layui-icon layui-icon-more" onclick="$('.sub-menu').slideToggle();">
					<div class="sub-menu">
						<ul>
							<li onclick="window.location.href = 'onlineOperation/mStandbyBuyRequestList.action';">查看申请记录</li>
						</ul>
					</div>
				</span>
			</div>
				...
				<form class="layui-form form-apply" action="" method="post">
					...
					<div class="layui-form-item">
 					...
 					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input id='proposer_unit' name="proposer_unit" class="layui-input" lay-verify="required"/>
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">请购区域 :</label>
						<div class="layui-input-block">
							<select id='buy_area' name="buy_area" lay-search></select>
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">需求日期 :</label>
						<div class="layui-input-block">
							<input type="text" name="demand_date" id="date1" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
 					...
 					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<textarea class="layui-textarea" name="technology_require" placeholder="请务必填写技术要求" lay-verify="required"></textarea>
						</div>
 					</div>
 					<div class="layui-form-item">
						<label class="layui-form-label">其它说明 :</label>
						<div class="layui-input-block">
							<textarea class="layui-textarea" name="else_explain"></textarea>
						</div>
 					</div>
					<!-- 明细信息 -->
						...
						<div class="apply-detail">
							...
							<div class="details">
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" name="apply_firm" class="layui-input" >
									</div>
								</div>
								<div class="layui-form-item">
				...
				//监听提交按钮
              	form.on('submit(submitForm)', function(data){
					...
					$.each($('.details'),function(index,item){
                        var parts_name = $(item).find('input[name="product_name"]').val();
