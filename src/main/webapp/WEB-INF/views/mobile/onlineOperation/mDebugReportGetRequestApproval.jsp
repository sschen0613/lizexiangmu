    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="enterprise_name" id="enterprise_name" value="'+item.currency_string5+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">设备名称 :</label>'
							 +				'<input type="text" name="equipment_name" id="equipment_name" value="'+item.currency_string12+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 ...
							 +				'<textarea name="remark" readonly>'+item.currency_string11+'</textarea>'
							 +			'</div>'
