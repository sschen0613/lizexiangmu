    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="onlineOperation/mTechnicalSupportDetectionDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=41&approval_id=41'
    				    				 +'&currency_number='+item.currency_number
    				    				 +'&staff_name='+item.staff_name+'&department_name='+item.department_name
