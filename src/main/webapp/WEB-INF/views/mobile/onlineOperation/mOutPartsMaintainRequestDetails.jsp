    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +		/*	'<div>'
							 +				'<label class="">申请事由 :</label>'
							 +				'<textarea class="layui-textarea" name="proposer_reason" readonly>'+currency_string4+'</textarea>'
							 +			'</div>'*/
							 +			'<div>'
							 +				'<label class="">故障描述 :</label>'
							 +				'<textarea class="layui-textarea" name="breakdown_describe" readonly>'+currency_string4+'</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">申请原因 :</label>'
							 +				'<textarea class="layui-textarea" name="proposer_for" readonly>'+currency_string5+'</textarea>'
							 +			'</div>'
							...
							success:function(res){
								...
								$.each(res.data,function(index,item){
									html0+=	'<div class="approval-detail">'
							 		 	 ...
							 		 	 +				'<input type="text" name="enterprise_name" value="'+item.details_string8+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">配件名称 :</label>'
							 		 	 +				'<input type="text" name="parts_name" value="'+item.details_string2+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 ...
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">用途 :</label>'
							 		 	 +				'<input type="text" name="service_character" value="'+item.details_string9+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">备注 :</label>'
							 		 	 +				'<input type="text" name="remark" value="'+item.details_string3+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +		'</div>'
							 		 	 +	'</div>';
								});
