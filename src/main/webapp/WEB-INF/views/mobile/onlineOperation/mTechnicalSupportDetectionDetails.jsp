    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="detection_program" id="detection_program" value="'+currency_string5+'" class="layui-input" readonly>'
							 +			'</div>'
                            +			'<div>'
                            +				'<label class="">计划检测日期 :</label>'
                            +				'<input type="text" name="plan_date" id="plan_date" value="'+currency_date3+'" class="layui-input" readonly>'
                            +			'</div>'
							 +			'<div>'
							 +				'<label class="">计划完成时间 :</label>'
							 +				'<input type="text" name="plan_accomplishDate" id="plan_accomplishDate" value="'+currency_date2+'" class="layui-input" readonly>'
							 +			'</div>'
                            +			'<div>'
                            +				'<label class="">客户名称 :</label>'
                            +				'<input type="text" name="client_name" id="client_name" value="'+currency_string2+'" class="layui-input" readonly>'
                            +			'</div>'
							 +			'<div>'
