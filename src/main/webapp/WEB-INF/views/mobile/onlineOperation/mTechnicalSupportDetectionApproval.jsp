    			...
    			$.ajax({
    				...
    				success:function(res){
						...
						html += '<div class="content-list style">'
                            ...
                            +				'<input type="text" name="plan_date" id="plan_date" value="'+Format(item.currency_date3,"yyyy-MM-dd")+'" class="layui-input" readonly>'
                            +			'</div>'
							 +			'<div>'
                            ...
                            +				'<input type="text" name="client_name" id="client_name" value="'+item.currency_string2+'" class="layui-input" readonly>'
                            +			'</div>'
							 +			'<div>'
							 ...
							 +				'<input type="text" name="monitor_site" id="monitor_site" value="'+item.currency_string7+'" class="layui-input" readonly>'
							 +			'</div>'
