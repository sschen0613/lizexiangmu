	...
	<body>
		<div class="container-apply">
			<div class="approval-list-title">
				...
				<h2 class="">试剂标液配置领取申请</h2>
				<span class="menu layui-icon layui-icon-more" onclick="$('.sub-menu').slideToggle();">
					<div class="sub-menu">
						<ul>
							<li onclick="window.location.href = 'onlineOperation/mReagentGetRequestList.action';">查看申请记录</li>
						</ul>
					</div>
				</span>
			</div>
				...
				<form class="layui-form form-apply" action="" method="post">
					...
					<div class="layui-form-item">
 					...
 					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<select name="proposer_type" id="proposer_type" lay-filter="proposer_type" class="layui-select" lay-search lay-verify="required">
								<option value="试剂配置">试剂配置</option>
								<option value="标液配制">标液配制</option>
								<option value="药品申领">药品申领</option>
							</select>
						</div>
 					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="require_date" id="date1" class="layui-input" lay-verify="required">
						</div>
					</div>
					<!-- 明细信息 -->
					...
					<div class="apply-detail-container">
						<div class="apply-detail">
							...
							<div class="details">
								...
								<div class="layui-form-item">
									<label class="layui-form-label">试剂/标液名称 :</label>
									<div class="layui-input-block">
										<input type="text" name="product_name" class="layui-input" lay-verify="required">
									</div>
								</div>
								<div class="layui-form-item">
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" name="buy_quantity" class="layui-input" lay-verify="required">
									</div>
								</div>
								<div class="layui-form-item">
								...
								<div class="layui-form-item">
									<label class="layui-form-label">使用企业 :</label>
									<div class="layui-input-block">
										<select name="enterprise" id="enterprise1" lay-filter="enterprise1" lay-search lay-verify="required"></select>
									</div>
								</div>
								<div class="layui-form-item">
...
// 				form.render('radio');
				...
				//监听提交按钮
              	form.on('submit(submitForm)', function(data){
					...
					var proposer_type = data.field.proposer_type;
					var require_date = data.field.require_date;
                ...
                $('.addDetails').click(function(){
                  ...
                  var html = ''
                    ...
                    +    '<div class="details">'
                      ...
                      +        '<label class="layui-form-label">序号 :</label>'
                      +        '<div class="layui-input-block">'
                      +          '<input type="text" name="number" value="'+(n_count)+'" class="layui-input" readonly>'
                      +        '</div>'
                      +      '</div>'
                      +      '<div class="layui-form-item">'
                      +        '<label class="layui-form-label">试剂/标液名称 :</label>'
                    ...
                    +        '<label class="layui-form-label">使用企业 :</label>'
                    +        '<div class="layui-input-block">'
                    +          '<select name="enterprise" id="enterprise'+d_count+'" lay-filter="enterprise'+d_count+'" lay-search lay-verify="required"></select>'
                    +        '</div>'
                    +      '</div>'
                    +      '<div class="layui-form-item">'
                    +        '<label class="layui-form-label">备注 :</label>'
