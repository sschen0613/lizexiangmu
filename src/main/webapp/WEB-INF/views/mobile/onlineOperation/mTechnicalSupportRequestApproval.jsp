							...
							success:function(res){
								...
								$.each(res.data,function(index,item){
									html0+=	'<div class="approval-detail">'
							 		 	 ...
							 		 	 +				'<input type="text" name="equipment_name" value="'+item.details_string5+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 ...
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">服务性质 :</label>'
							 		 	 +				'<input type="text" name="service_character" value="'+item.details_string8+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">问题描述 :</label>'
							 		 	 +				'<input type="text" name="problem_describe" value="'+item.details_string9+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">备注 :</label>'
