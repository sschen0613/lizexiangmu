                    ...
                    success:function(res){
                        ...
                        $.each(res.data,function(index,item){
                            html0+=	'<div class="approval-detail">'
                                ...
                                +		'<div class="details">'
                                +			'<div>'
                                +				'<label class="">采样人员 :</label> '
                                +				'<input type="text" name="sampleType" value="'+item.details_string4+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
                                +				'<label class="">检测类型 :</label> '
                                +				'<input type="text" name="sampleType" value="'+(item.details_int3 == 1 ? "常规检测" : "在线比对")+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
                                +				'<label class="">采样类型 :</label>'
                                +				'<input type="text" name="testType" value="'+(item.details_int4 == 1 ? "超低排放" : "非超低排放")+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
                                ...
                                +				'<input type="text" name="sum" value="'+item.details_money2+'" class="layui-input" readonly>'
                                +			'</div>'
                                +			'<div>'
