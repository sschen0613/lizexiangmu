		...
		<div class="container-apply">
			<div class="approval-list-title">
				...
				<span class="menu layui-icon layui-icon-more" onclick="$('.sub-menu').slideToggle();">
					<div class="sub-menu">
						<ul>
							<li onclick="window.location.href = 'storage/mOutlibraryOfDrugsList.action';">查看申请记录</li>
						</ul>
					</div>
				</span>
			</div>
			<div class="content">
				...
				<form class="layui-form form-apply" action="" method="post">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<select name="subordinate_companies" id="subordinate_companies" lay-filter="subordinate_companies" lay-search lay-verify="required"></select>
						</div>
					</div>
					<div class="layui-form-item">
