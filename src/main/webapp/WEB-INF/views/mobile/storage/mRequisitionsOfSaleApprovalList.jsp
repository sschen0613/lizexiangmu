	...
	<body>
		...
		<script type="text/javascript">
            layui.use(['form','element','layer','laydate','flow' ],function(){
    			...
    			$.ajax({
    				url:'Currency/selectCurrencyApprover1.action?currency_type='+ currency_type+"&currency_string="+staffid,
    				type:'post',
    				dataType:'JSON',
    				beforeSend: function(){
    					layer.load(1);
    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="storage/mRequisitionsOfSaleSuppliesApproval.action?currency_id='+item.currency_id
                                 +		'&dingStaffid='+staffid
