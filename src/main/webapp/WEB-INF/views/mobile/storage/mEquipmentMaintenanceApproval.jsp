    			...
    			$.ajax({
    				...
    				success:function(res){
    					...
    					html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="technical_requirementsvarchar" id="technical_requirementsvarchar" value="'+item.currency_string8+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">其它说明 :</label>'
							 +				'<input type="text" name="other_description" id="other_description" value="'+item.currency_string9+'" class="layui-input" readonly>'
							 +			'</div>'
                             +			'<div>'
                             +				'<label class="">维修建议厂家 :</label>'
                             +				'<input type="text" name="suggest" id="suggest" value="'+item.currency_string10+'" class="layui-input" readonly>'
                             +			'</div>'
