    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="storage/mRequisitionsOfSaleDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=9&approval_id=9'
    				    				 ...
    				    				 +'&currency_string2='+item.currency_string2+'&currency_string4='+item.currency_string4
    				    				 +'&currency_string3='+item.currency_string3+'&currency_string='+item.currency_string
    				    				 +'&currency_string5='+item.currency_string5+'&currency_string11='+item.currency_string11+'&currency_string7='+item.currency_string7
    				    				 +'&currency_int='+item.currency_int
    				    				 +'&currency_date2='+Format(item.currency_date2,"yyyy-MM-dd")
    				    				 +'&currency_money='+item.currency_money+'&currency_money2='+item.currency_money2+'&currency_money3='+item.currency_money3+'&currency_money6='+item.currency_money6
