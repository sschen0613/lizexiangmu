    			...
    			$.ajax({
    				...
    				success:function(res){
    					...
    					html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" id="" name="" value="'+item.currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">申请事由 :</label>'
							 +				'<textarea type="text" name="apply_reason" value="'+item.currency_string7+'" class="layui-textarea" readonly></textarea>'
							 +			'</div>'
// 							 +			'<div>'
