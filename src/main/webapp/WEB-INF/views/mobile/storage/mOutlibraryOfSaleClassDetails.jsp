	...
	<body>
		...
		<script type="text/javascript">
            layui.use(['form','element','layer','laydate','table' ],function(){
                ...
                var currency_string11 = '${param.currency_string11}'; //合同名称
                var currency_string3 = '${param.currency_string3}'; //合同编号
...
// 							 +			'</div>'
							 ...
							 +				'<input type="text" id="customer_name" name="customer_name" value="'+currency_string11+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
