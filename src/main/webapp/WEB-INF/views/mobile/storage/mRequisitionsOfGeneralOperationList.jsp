    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="storage/mRequisitionsOfGeneralOperationDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=10&approval_id=10'
    				    				 ...
    				    				 +'&currency_string2='+item.currency_string2+'&currency_int='+item.currency_int+'&currency_int2='+item.currency_int2+'&currency_int3='+item.currency_int3
    				    				 +'&currency_string3='+item.currency_string3+'&currency_string4='+item.currency_string4
    				    				 +'&currency_string5='+item.currency_string5+'&currency_string9='+item.currency_string9+'&currency_string11='+item.currency_string11
                                		...
                                		+'&currency_date4='+Format(item.currency_date4,"yyyy-MM-dd")
    				    				 ...
    				    				 +'&currency_string7='+item.currency_string7+'&currency_date2='+item.currency_date2+'&currency_date3='+item.currency_date3
