	...
	<body>
		<div class="container-apply">
			<div class="approval-list-title">
				...
				<h2 class="">信泽材料出库申请</h2>
				<span class="menu layui-icon layui-icon-more" onclick="$('.sub-menu').slideToggle();">
					<div class="sub-menu">
						<ul>
							<li onclick="window.location.href = 'storage/mOutlibraryOfMaterialList.action';">查看申请记录</li>
						</ul>
					</div>
				</span>
			</div>
				...
				//监听提交按钮
              	form.on('submit(submitForm)', function(data){
					...
					$.each($('.details'),function(index,item){
						...
						var fAvaQuantity = Number($(item).find('input[name="inventory_quantity"]').val());
