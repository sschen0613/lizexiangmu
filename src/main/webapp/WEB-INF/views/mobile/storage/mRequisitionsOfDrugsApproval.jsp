    			...
    			$.ajax({
    				...
    				success:function(res){
    					...
    					html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="technical_requirementsvarchar" id="date" value="'+item.currency_string8+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">其它说明 :</label>'
							 +				'<input type="text" name="other_description" id="date" value="'+item.currency_string9+'" class="layui-input" readonly>'
							 +			'</div>'
								...
								$.each(res.data,function(index,item){
									html0+=	'<div class="approval-detail">'
									 	 ...
									 	 +				'<label class="">物品名称 :</label> '
							 		 	 +				'<input type="text" name="product_name" value="'+item.details_string2+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 ...
							 		 	 +				'<input type="text" name="inventory_quantity" value="'+item.details_money2+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">使用科室 :</label>'
							 		 	 +				'<input type="text" name="administrative_office" value="'+item.details_string8+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +		'</div>'
							 		 	 +	'</div>';
								});
