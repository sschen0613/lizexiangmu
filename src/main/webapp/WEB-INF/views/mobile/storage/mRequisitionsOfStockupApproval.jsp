    			...
    			$.ajax({
    				...
    				success:function(res){
    					...
    					html += '<div class="content-list style">'
							 ...
							 +				'<textarea id="illustration" name="illustration" class="layui-textarea" value="" readonly>用于丽泽公司备货（包含设备、配件）</textarea>'
							 +			'</div>'
							 +			'<div>'
								...
								$.each(res.data,function(index,item){
									html0+=	'<div class="approval-detail">'
									 	 ...
									 	 +				'<label class="">存货编码 :</label> '
							 		 	 ...
							 		 	 +				'<input type="text" name="recent_price" value="'+item.details_money4+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +		'</div>'
							 		 	 +	'</div>';
								});
