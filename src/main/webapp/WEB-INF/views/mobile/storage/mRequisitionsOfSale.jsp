				...
				//监听提交按钮
              	form.on('submit(submitForm)', function(data){
					...
					$.each($('.details'),function(index,item){
                        ...
                        var dbl_price = Number($(item).find('input[name="dbl_price"]').val()); //最近日期商品价格
    							...
    							$.ajax({
                                    ...
                                    url:'System/selectInvSPrice.action',
	    				       		...
	    				       		success:function(res){
                                        ...
                                        if(res.data != null) recentPrice = res.data.iInvSPrice;//参考成本
                                        if(res.data != null) iInvLSCost = res.data.iInvLSCost;//最低售价
	    				       			var html = ''
                                            ...
                                            +        '<div class="layui-input-block">'
                                            +          '<input type="text" name="iInvLSCost" value="'+iInvLSCost+'" class="layui-input" readonly>'
                                            +        '</div>'
                                            +      '</div>'
											+		'<div class="layui-form-item" style="display: none">'
											+        '<label class="layui-form-label">销售单价 :</label>'
											+        '<div class="layui-input-block">'
											+          '<input type="text" name="dbl_price" value="'+item.含税原币单价+'" class="layui-input" readonly>'
											+        '</div>'
											+      '</div>'
	        			                    +    '</div>'
