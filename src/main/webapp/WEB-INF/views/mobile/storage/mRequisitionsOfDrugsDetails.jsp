    			...
    			$.ajax({
    				...
    				success:function(res){
    					...
    					html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="technical_requirementsvarchar" id="date" value="'+currency_string8+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">其它说明 :</label>'
							 +				'<input type="text" name="other_description" id="date" value="'+currency_string9+'" class="layui-input" readonly>'
							 +			'</div>'
