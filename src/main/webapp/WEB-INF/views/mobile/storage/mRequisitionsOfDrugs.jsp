		...
		<div class="container-apply">
			<div class="approval-list-title">
				...
				<span class="menu layui-icon layui-icon-more" onclick="$('.sub-menu').slideToggle();">
					<div class="sub-menu">
						<ul>
							<li onclick="window.location.href = 'storage/mRequisitionsOfDrugsList.action';">查看申请记录</li>
						</ul>
					</div>
				</span>
			</div>
			<div class="content">
				<form class="layui-form form-apply" action="" method="post">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<textarea class="layui-textarea" name="technical_requirements" placeholder="请务必填写技术要求" lay-verify="required"></textarea>
						</div>
					</div>
					<div class="layui-form-item">
							...
							<div class="details">
								<div class="layui-form-item">
									...
									<div id="container1" class="layui-input-block container container1">
										<input id="product_name" name="product_name" type="text" class="layui-input" placeholder="商品名称" lay-verify="required">
									</div>
								</div>
								<div class="layui-form-item">
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" name="inventory_quantity" class="layui-input" lay-verify="required">
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label">使用科室 :</label>
									<div class="layui-input-block">
										<select name="administrative_office" id="administrative_office" lay-search lay-verify="required"></select>
									</div>
								</div>
							</div>
            ...
            layui.use(['form','element','layer','laydate' ],function(){
                ...
                $('.addDetails').click(function(){
                  ...
                  var html = ''
                    ...
                    +          '<input id="product_name" type="text" name="product_name" class="layui-input" placeholder="输入商品名称" lay-verify="required">'
                    +        '</div>'
                    +      '</div>'
                    +      '<div class="layui-form-item">'
                    +        '<label class="layui-form-label">规格型号 :</label>'
                    ...
                    +        '<label class="layui-form-label">使用科室 :</label>'
                    +        '<div class="layui-input-block">'
                    +          '<select name="administrative_office" id="administrative_office'+d_count+'" lay-search lay-verify="required">'+information_html+'</select>'
                    +        '</div>'
                    +      '</div>'
                    +    '</div>'
