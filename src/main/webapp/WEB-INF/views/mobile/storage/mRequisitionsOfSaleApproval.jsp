...
//页面内容初始化
                        $.ajax({
                            url:'Currency/selectCurrencyApprover1.action',
                            type:'post',
                            data:{
                            ...
                            success:function(res){
                                ...
                                $.ajax({
                                    ...
                                    success:function(result){
                                        ...
                                        var html1 = '';
                                        if (item.currency_type == 9 && position == 62){
                                            html1 +=	'<div>'
                                                +				'<label class="">发货类型 :</label>'
                                                +				'<input type="radio" name="delivery_type" value="直发企业" title="直发企业" checked>直发企业'
                                                +				'<input type="radio" name="delivery_type" value="单位入库" title="单位入库">单位入库'
                                                +			'</div>'
                                        }
                                        ...
                                        html += '<div class="content-list style">'
                                            ...
                                            +				'<textarea id="illustration" name="illustration" class="layui-textarea" value="'+item.currency_string+'" readonly>'+item.currency_string+'</textarea>'
                                            +			'</div>'
                                            +			'<div>'
                                            ...
                                            /*+			'<div>'
                                         +				'<label class="">发货类型 :</label>'
                                         +				'<input type="text" id="delivery_type" name="delivery_type" value="'+item.currency_int4+'" class="layui-input" readonly>'
                                         +			'</div>'*/
                                            +			'<div>'
                                         ...
                                         +				'<input type="text" name="expectedArrival_date" id="date2" value="'+Format(item.currency_date3,'yyyy-MM-dd')+'" class="layui-input" readonly>'
                                         +			'</div>'
                                          +			'<div>'
                                         +				'<label class="">物资部库管员确认入库 :</label>'
                                         +				'<input type="text" id="confirm_inventory" name="confirm_inventory" value="'+item.currency_int2+'" class="layui-input" readonly>'
                                          +			'</div>'*/
                                            // 							 +			'<div>'
                                            ...
                                            +			'</div>';
                                        html +=			html1;
                                        html +=			'<div class="approval-progress">'
                                        ...
                                        var currency_type = item.currency_type;
                                        if (currency_type == 54){
                                            approvalOpinion_type = 54;
                                            approval_id = 54;
                                        }
                                            ...
                                            success:function(res){
                                                ...
                                                $.each(res.data,function(index,item){
                                                    html0+=	'<div class="approval-detail">'
                                                        ...
                                                        +				'<input type="text" name="dbl_price" value="'+item.details_string9+'" class="layui-input" readonly>'
                                                        +			'</div>'
                                                        +		'</div>'
                                                        +	'</div>';
                                                });
                                        ...
                                        switch(approverState){
                                            ...
                                            case 'waitting':
                                                ...
                                                //审批按钮绑定点击事件
                                                var dataAjax = {"currency_string":staffid,"currency_type":approval_id,"currency_id":currency_id,"position":position};
