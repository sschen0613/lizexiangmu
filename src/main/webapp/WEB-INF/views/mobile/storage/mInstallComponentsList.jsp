    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="storage/mInstallComponentsDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=62&approval_id=62'
    				    				 ...
    				    				 +'&currency_string='+item.currency_string+'&currency_date3='+Format(item.currency_date3,"yyyy-MM-dd")
