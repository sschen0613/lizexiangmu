    			...
    			$.ajax({
    				...
    				success:function(res){
    					...
    					html += '<div class="content-list style">'
							 ...
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">故障描述 :</label>'
							 +				'<textarea type="text" name="apply_reason" value="" class="layui-textarea" readonly>'+currency_string7+'</textarea>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">技术要求 :</label>'
							 +				'<input type="text" name="technical_requirementsvarchar" id="technical_requirementsvarchar" value="'+currency_string8+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">其它说明 :</label>'
							 +				'<input type="text" name="other_description" id="other_description" value="'+currency_string9+'" class="layui-input" readonly>'
							 +			'</div>'
                             +			'<div>'
                             +				'<label class="">维修建议厂家 :</label>'
                             +				'<input type="text" name="suggest" id="suggest" value="'+currency_string10+'" class="layui-input" readonly>'
                             +			'</div>'
								...
								$.each(res.data,function(index,item){
									html0+=	'<div class="approval-detail">'
									 	 ...
									 	 +				'<label class="">设备名称 :</label> '
							 		 	 ...
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">设备厂家 :</label>'
							 		 	 +				'<input type="text" name="product_manufacturer" value="'+item.details_string2+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
