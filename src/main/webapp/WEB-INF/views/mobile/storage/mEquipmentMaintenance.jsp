	...
	<body>
		<div class="container-apply">
			<div class="approval-list-title">
				...
				<h2 class="">信则设备维修申请</h2>
				<span class="menu layui-icon layui-icon-more" onclick="$('.sub-menu').slideToggle();">
					<div class="sub-menu">
						<ul>
							<li onclick="window.location.href = 'storage/mEquipmentMaintenanceList.action';">查看申请记录</li>
						</ul>
					</div>
				</span>
			</div>
				...
				<form class="layui-form form-apply" action="" method="post">
					...
					<div class="layui-form-item">
 					...
 					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<textarea class="layui-textarea" name="error_description" placeholder="请务必填写故障描述" lay-verify="required"></textarea>
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">技术要求 :</label>
						<div class="layui-input-block">
							<textarea class="layui-textarea" name="technical_requirementsvarchar" placeholder="请务必填写故障描述" lay-verify="required"></textarea>
						</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<textarea class="layui-textarea" name="suggest"></textarea>
						</div>
					</div>
						...
						<div class="apply-detail">
							...
							<div class="details">
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" id="product_name" name="product_name" class="layui-input" lay-verify="required">
									</div>
								</div>
								<div class="layui-form-item">
            ...
            layui.use(['form','element','layer','laydate' ],function(){
				...
				//监听提交按钮
              	form.on('submit(submitForm)', function(data){
                    ...
                    var technical_requirements = data.field.technical_requirementsvarchar;//技术要求
