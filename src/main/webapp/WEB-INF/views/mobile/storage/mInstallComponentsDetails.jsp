    			...
    			$.ajax({
    				...
    				success:function(res){
    					...
    					html += '<div class="content-list style">'
							 ...
							 +				'<textarea id="illustration" name="illustration" class="layui-textarea" value="" readonly>用于丽泽公司安装组配件采购</textarea>'
							 +			'</div>'
							 +			'<div>'
							...
							+				'<input type="text" name="currency_applicant" id="staffName" value="'+currency_string2+'" class="layui-input" readonly>'
							+			'</div>'
							+			'<div>'
							+				'<label class="">使用企业 :</label>'
							+				'<input type="text" name="currency_applicant" id="staffName" value="'+currency_string3+'" class="layui-input" readonly>'
							+			'</div>'
							 +			'<div>'
