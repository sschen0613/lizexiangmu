	...
	<body>
		...
		<script type="text/javascript">
            layui.use(['form','element','layer','laydate','table' ],function(){
                ...
                var currency_string2 = '${param.currency_string2}'; //所属公司
                var currency_string7 = '${param.currency_string7}'; //申请事由
                var currency_string8 = '${param.currency_string8}'; //仓库
    			...
    			$.ajax({
    				...
    				success:function(res){
    					...
    					html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" id="" name="" value="'+currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 ...
							 +				'<input type="text" id="cangku" name="cangku" value="'+currency_string8+'" class="layui-input" readonly>'
							 +			'</div>'
...
// 							 		 	 +				'<input type="text" name="recent_price" value="" class="layui-input" readonly>'
// 							 		 	 +			'</div>'
							 		 	 +		'</div>'
							 		 	 +	'</div>';
								});
