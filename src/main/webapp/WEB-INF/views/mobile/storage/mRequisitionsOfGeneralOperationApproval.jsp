                                ...
                                $.ajax({
                                    ...
                                    success:function(result){
                                        ...
                                        html += '<div class="content-list style">'
                                            ...
                                            +				'<input type="text" id="customer_name" name="customer_name" value="'+item.currency_string7+'" class="layui-input" readonly>'
                                            +			'</div>'
                                            +			'<div>'
                                            ...
                                            +				'<input type="text" id="delivery_type" name="delivery_type" value="'+(item.currency_int2==1?'BO设备出库':'运营设备出库')+'" class="layui-input" readonly>'
                                            +			'</div>'*/
                                            +			'<div>'
                                            +				'<label class="">申请类型 :</label>'
                                            +				'<input type="text" id="applyType" name="applyType" value="'+(item.currency_int3==1?'普通请购':'维修入库')+'" class="layui-input" readonly>'
                                            +			'</div>'
                                            +			'<div>'
                                            +				'<label class="">货品流转编码 :</label>'
                                            +				'<input type="text" id="productNumber" name="productNumber" value="'+(item.currency_string9=='undefined'?'无':item.currency_string9)+'" class="layui-input" readonly>'
                                            +			'</div>'
                                            +			'<div>'
                                            +				'<label class="">运营合同起止时间 :</label>'
                                            +				'<input type="text" name="beginning_endingtime" id="date1" value="'+Format(item.currency_date2,'yyyy-MM-dd')+'" class="layui-input" readonly>-'
                                            +				'<input type="text" name="endning_endingtime" id="date1" value="'+Format(item.currency_date4,'yyyy-MM-dd')+'" class="layui-input" readonly>'
                                            +			'</div>'
                                            +			'<div>'
                                            ...
                                            +				'<input type="text" id="contract_amount" name="contract_amount" value="'+contractAmount+'" class="layui-input" readonly>'
                                            +			'</div>'
                                            +			'<div>'
                                            ...
                                            success:function(res){
                                                ...
                                                $.each(res.data,function(index,item){
                                                    html0+=	'<div class="approval-detail">'
                                                        ...
                                                        // 							 		 	 +			'</div>'
                                                        /*+			'<div>'
                                                        +				'<label class="">设备开始日期 :</label>'
                                                        +				'<input type="text" name="start_date" value="'+Format(item.details_date2,'yyyy-MM-dd')+'" class="layui-input" readonly>'
                                                        +			'</div>'
                                                        +			'<div>'
                                                        +				'<label class="">设备结束日期 :</label>'
                                                        +				'<input type="text" name="over_date" value="'+Format(item.details_date3,'yyyy-MM-dd')+'" class="layui-input" readonly>'
                                                        +			'</div>'*/
                                                        +			'<div>'
                                                        ...
                                                        +				'<input type="text" name="fAvaQuantity" value="'+item.details_money3+'" class="layui-input" readonly>'
                                                        +			'</div>'
                                                        +			'<div name="recent">'
                                                        +				'<label class="">物品报价 :</label>'
                                                        +				'<input type="text" name="item_offer" value="'+item.details_money4+'" class="layui-input" readonly>'
                                                        +			'</div>'
                                                        +		'</div>'
                                                        +	'</div>';
                                                });
