	...
	<div class="approval-list-content">
		<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
			...
			<div class="layui-tab-content" style="height:100%;">
				<div class="layui-tab-item waitting">
					<ul id="waitting_demo">
						<!-- 待审批 -->
					</ul>
				</div>
...
<script type="text/javascript">
    layui.use(['form','element','layer','laydate','flow' ],function(){
        ...
        $.ajax({
            url:'Xinze/selectApplicantCurrency.action?currency_type='+ currency_type+'&currency_int=0&currency_int2=1',
            type:'post',
            dataType:'JSON',
            beforeSend: function(){
                layer.load(1);
            ...
            success:function(res){
                ...
                $.each(res.data,function(index,item){
                    ...
                    html += '<li>'
                        ...
                        +		'<a href="testingProcess/samplingMessage/mSamplingTaskRegister.action?currency_id='+item.currency_id
                        +'&id="a'+index+'" onclick="approvalDetails(this);return false;">'
                        +			'采样任务登记'
                        +			'<span class="layui-icon layui-icon-right"></span>'
                        +		'</a>'
                       /* +		'<a href="'+item.currency_id+'"'
                        +		' onclick="endTest(this);return false;">'
                        +			'结束流程'
                        +			'<span class="layui-icon layui-icon-right"></span>'
                        +		'</a>'*/
                        +	'</li>';
