    			...
    			$.ajax({
    				...
    				success:function(res){
    					...
    					html += '<div class="content-list style">'
							 ...
							 +				'<input type="text" name="program_name" value="'+item.currency_string2+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">联系人 :</label>'
							 +				'<input type="text" name="contact_person" value="'+item.currency_string3+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">联系电话 :</label>'
							 +				'<input type="text" name="contact_phone" value="'+item.currency_string4+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">委托单位地址 :</label>'
							 +				'<input type="text" name="entrust_adress" value="'+item.currency_string5+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">委托单位名称 :</label>'
							 +				'<input type="text" name="entrust_name" value="'+item.currency_string10+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 +				'<label class="">报表编码 :</label>'
							 +				'<input type="text" name="specimen_name" value="'+item.currency_string7+'" class="layui-input" readonly>'
							 +			'</div>'
                             +			'<div>'
                             +				'<label class="">样品来源 :</label>'
                             +				'<input type="text" name="specimen_name" value="'+(item.currency_int2==1 ? "现场采样" : "送样")+'" class="layui-input" readonly>'
                             +			'</div>'
							 +			'<div>'
							 +				'<label class="">采样完成时间 :</label>'
							 +				'<input type="text" name="date1" value="'+Format(item.currency_date2,"yyyy-MM-dd")+'" class="layui-input" readonly>'
							 +			'</div>'
							 +			'<div>'
							 ...
							 +				'<input type="text" name="standard" value="'+item.currency_string9+'" class="layui-input" readonly>'
							 +			'</div>'
								...
								$.each(res.data,function(index,item){
									html0+=	'<div class="approval-detail">'
									 	 ...
									 	 +				'<label class="">检测点位 :</label> '
							 		 	 +				'<input type="text" name="" value="'+item.details_string+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">检测项目 :</label>'
							 		 	 +				'<input type="text" name="" value="'+item.processName+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">方法依据 :</label>'
							 		 	 +				'<input type="text" name="" value="'+item.methodBasis+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">检测频次 :</label>'
							 		 	 +				'<input type="text" name="" value="'+item.details_int3+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">检测天数 :</label>'
							 		 	 +				'<input type="text" name="" value="'+item.details_int4+'" class="layui-input" readonly>'
							 		 	 +			'</div>'
							 		 	 +			'<div>'
							 		 	 +				'<label class="">备注 :</label>'
