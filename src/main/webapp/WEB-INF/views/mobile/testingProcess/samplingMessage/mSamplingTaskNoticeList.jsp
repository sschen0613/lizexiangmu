    				...
    				success:function(res){
    					...
    					$.each(res.data,function(index,item){
    						...
    						html += '<li>'
    				    		 ...
    				    		 +		'<a href="testingProcess/samplingMessage/mSamplingTaskNoticeDetails.action?currency_id='+item.currency_id
    				    				 +'&current_approvalCount='+item.current_approvalCount
    				    				 +'&approver_count='+item.approver_count
    				    				 +'&approvalOpinion_type=43&approval_id=43'
										 ...
										 +'&currency_string='+item.currency_string+'&currency_string2='+item.currency_string2+'&currency_string3='+item.currency_string3+'&currency_string4='+item.currency_string4+'&currency_string5='+item.currency_string5
										 ...
										 +'&currency_int='+item.currency_int+'&currency_int2='+item.currency_int2
