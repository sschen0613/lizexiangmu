	 		...
	 		<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="text" name="staff_name" required  lay-verify="" placeholder="请输入联系人" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label label-revise">项目名称 :</label>
					<div class="layui-input-block">
						<input type="text" name="" required  lay-verify="" placeholder="请输入项目名称" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label label-revise">任务下达时间 :</label>
					<div class="layui-input-block">
						<input name="startDate" type="text" class="layui-input input-revise date-revise" id="date1" placeholder="任务下达时间">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label label-revise">要求完成时间 :</label>
					<div class="layui-input-block">
...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						,{field: 'currency_number', title: '编码单号', minWidth:200}
						...
						,{field: 'currency_string7', title: '样品编码', minWidth:100}
						,{field: 'currency_date2', title: '任务下达时间', sort: true, minWidth:120, templet:'<div>{{ Format(d.currency_date,"yyyy-MM-dd")}}</div>'}
						,{field: 'currency_string8', title: '检测类型', minWidth:100}
						,{field: 'currency_date3', title: '要求完成时间', sort: true, minWidth:120, templet:'<div>{{ Format(d.currency_date,"yyyy-MM-dd")}}</div>'}
					...
					if(layEvent === 'detail'){ //查看
						...
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=45"//iframe的url
						}); 
						...
						layer.open({
							...
							maxmin: true,
							area: ['30%', '40%'],
							content: 'Currency/approvalOpinion.action?approval_id=45&currency_id='+data.currency_id
						});
					}
				});
