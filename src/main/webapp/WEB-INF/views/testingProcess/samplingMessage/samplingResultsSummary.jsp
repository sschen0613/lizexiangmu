...
<html>
	...
	<body>
		...
		<script type="text/html" id="barDemo">
			<a class="layui-btn layui-btn-xs" lay-event="next">结果登记</a>
...
// 			    	,totalRow: true //开启合计行
				...
				table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
					...
					} else if(layEvent === 'next'){ //结果登记
						if (departmentId == 107738747) {
                            layer.open({
                                type: 2,
                                // skin:'layui-layer-molv', //layui-layer-lan
                                title: '',
                                ...
                                maxmin: true,
                                area: ['80%', '80%'],
                                content: 'testingProcess/samplingMessage/samplingResultsSummaryForm.action?currency_id=' + data.currency_id + '&currency_type=' + data.currency_type //iframe的url
                            });
                        }else {
                            layer.msg("无权限操作！！！");
						}
                    ...
                    switch(obj.event){
                        case 'look':
                            layer.open({
                                ...
                                maxmin: true,
                                area: ['80%', '80%'],
                                content: 'testingProcess/samplingMessage/samplingResultsSummaryList.action' //iframe的url
                            });
                            break;
                        case 'delete':
                            layer.msg('删除');
