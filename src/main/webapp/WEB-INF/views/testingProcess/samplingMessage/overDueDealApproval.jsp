...
// 			    	,totalRow: true //开启合计行
            ,cols: [[ //表头
				...
				,{field: 'currency_string7', title: '项目名称', minWidth:120}
				,{field: 'currency_string8', title: '合同编号', minWidth:120}
				,{field: 'currency_string9', title: '报告编码', minWidth:100}
        ...
        table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){ //查看
                ...
                layer.open({
                    ...
                    +data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=49"//iframe的url
                });
                ...
                layer.open({
                    ...
                    maxmin: true,
                    area: ['30%', '50%'],
                    content: 'Currency/approvalOpinion.action?approval_id=49&currency_id='+data.currency_id
                });
            }
        });
