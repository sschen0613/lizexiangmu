	...
	<body>
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">业务科绩效统计表</button>
			</div>
		</script>
			...
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
				...
				var tableInner = table.render({
					...
					,cols: [[ //表头
						...
						/*,{field: '', title: '业务内容',minWidth:100}*/
						,{field: 'currency_date2', title: '业务开始时间',minWidth:120, templet:'<div>{{ Format(d.currency_date2,"yyyy-MM-dd")}}</div>'}
						,{field: 'currency_date3', title: '业务结束时间',minWidth:120, templet:'<div>{{ Format(d.currency_date3,"yyyy-MM-dd")}}</div>'}
						,{field: 'staff_name', title: '业务负责人',minWidth:110}
						/*,{field: '', title: '解决部门负责人',minWidth:130}*/
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								maxmin: true,
								area: ['80%', '80%'],
								content: 'testingProcess/performance/businessSectionPerformanceManageForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
