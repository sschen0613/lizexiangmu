...
<!-- 				</div> -->
				...
				<div class="layui-inline">
					<label class="layui-form-label label-revise">合同名称:</label>
					<div class="layui-input-block">
						<input type="text" name="currency_string4" placeholder="合同名称 :" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
			  	<div class="layui-inline">
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">添加报告流转及盖章申请单</button>
			</div>
		</script>
...
// 				});
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=50' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '报告流转及盖章审批单'
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								//shadeClose: true,
								area: ['80%', '80%'],
								content: 'testingProcess/reportMoveStamp/reportMoveStampForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
