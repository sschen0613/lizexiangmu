	...
	<body>
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">丽泽公司销售合同发票开具请购单</button>
			</div>
		</script>
...
// 				});
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=28' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '丽泽销售合同发票开具申请'
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						,{field: 'currency_string4', title: '合同编号', minWidth: 100, sort: true}
						...
						/*,{field: 'details_string5', title: '货物名称', minWidth: 100}
						,{field: 'details_string8', title: '品牌', minWidth: 80}
					...
					switch(obj.event){
						case 'add':
							layer.open({
								type: 2,
								// skin:'layui-layer-molv', //layui-layer-lan
								title: '丽泽公司销售合同发票开具请购单填写',
								//shadeClose: true,
								shade: 0.8,
								maxmin: true,
								area: ['80%', '80%'],
								content: 'finance/invoiceOfSalesContractForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
