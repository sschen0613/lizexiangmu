	...
	<body>
	 	<form class="layui-form form-top" action="">
	 		<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="text" name="currency_string3" placeholder="客户名称 :" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
			  	<div class="layui-inline">
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">信泽公司检测合同发票开具请购单</button>
			</div>
		</script>
		...
		//一般直接写在一个js文件中
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
				...
				//查询所有部门
// 				$.ajax({
// 					url : "Department/selectDingDepartmentId.action.action?currency_type=29",
// 					type : "post",
// 					data : {},
// 					dataType : "JSON",
...
// 				});
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=29' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '信泽检测合同发票开具申请'
// 			    	,totalRow: true //开启合计行
...
// 						,{field: 'department_name', title: '申请部门', minWidth:100}
						...
						,{field: 'currency_string4', title: '合同编号', sort: true, minWidth:100}
						,{field: 'currency_string5', title: '开票名称', minWidth:100} 
						,{field: 'currency_string7', title: '税号', minWidth:150} 
						,{field: 'currency_string8', title: '地址', minWidth: 200} 
						,{field: 'currency_string9', title: '电话', minWidth: 100}
						,{field: 'currency_string10', title: '开户行', minWidth:150} 
						,{field: 'currency_string11', title: '账号', minWidth:150}
						//,{field: 'currency_string11', title: '合同付款约定', minWidth:120} 
						...
						,{field: 'currency_int3', title: '发票类型', minWidth:100,templet:'<div>{{d.currency_int3 == "1" ? "普通发票" : "专用发票"}}</div>'}
						,{field: 'currency_int4', title: '费用类型', minWidth:100,templet:'<div>{{d.currency_int4 == "1" ? "检测费" : "技术服务费"}}</div>'}
					...
					switch(obj.event){
						case 'add':
							layer.open({
								type: 2,
								// skin:'layui-layer-molv', //layui-layer-lan
								title: '信泽公司检测合同发票开具请购单填写',
								//shadeClose: true,
								shade: 0.8,
								maxmin: true,
								area: ['80%', '80%'],
								content: 'finance/invoiceOfInspectionContractForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
