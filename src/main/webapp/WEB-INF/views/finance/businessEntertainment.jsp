	...
	<body>
	 	<form class="layui-form form-top" action="">
	 		<div class="layui-form-item">
				...
				<div class="layui-inline">
					<label class="layui-form-label label-revise">客人单位 :</label>
					<div class="layui-input-block">
						<input type="text" name="currency_string4" placeholder="客人单位 :" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
			  	<div class="layui-inline">
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">业务招待申请表</button>
			</div>
		</script>
		...
		//一般直接写在一个js文件中
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
                ...
                form.on('submit(out)', function(data){
                    ...
                    var url = 'Currency/selectApplicantCurrency1.action?currency_type=30';
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            data.unshift({
                                ...
                                currency_string4:'客人单位',currency_int6:'客人人数',currency_string7: '招待事由',currency_string8: '陪同人',
                                currency_money6:'申请金额',currency_string5:'金额大写'
                            });
                            // 3. 执行导出函数，系统会弹出弹框
                            LAY_EXCEL.exportExcel(data, '业务招待申请.xlsx', 'xlsx');
                        }
                    });
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=30' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '业务招待申请'
// 			    	,totalRow: true //开启合计行
...
// 						,{field: 'department_name', title: '申请部门', minWidth:100}
						...
						,{field: 'currency_string4', title: '客人单位', minWidth:200}
				...
				table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
					...
					if(layEvent === 'detail'){ //查看明细
                        ...
                        layer.open({
                            ...
                            maxmin: true,
                            area: ['80%', '80%'],
                            content: 'Currency/businessEntertainmentPrint.action?currency_id='+data.currency_id+'&currency_type='+data.currency_type
                        });
                    }
				});
				//监听头工具栏事件
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								maxmin: true,
								area: ['80%', '80%'],
								content: 'finance/businessEntertainmentForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
