...
<div id="content" class="content">
    ...
    <table border="1" class="layui-table">
        ...
        <tr>
            <td>运营合同起止日期</td>
            <td colspan=2 id="date0"></td>
            <td>本次开票起止日期</td>
            <td colspan=2 id="date1"></td>
        </tr>
        <tr>
            <td>开票事由</td>
...
<script>
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            $("#date0").text(Format(res.data[0].currency_date2,"yyyy-MM-dd") +"至"+ Format(res.data[0].currency_date3,"yyyy-MM-dd"));
            $("#date1").text(Format(res.data[0].currency_date4,"yyyy-MM-dd") +"至"+ Format(res.data[0].currency_date5,"yyyy-MM-dd"));
