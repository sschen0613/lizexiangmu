...
//监听搜索提交按钮
  ...
  table.render({
    elem: '#test'
    ,url: '../System/getNotyet.action' //数据接口
    ,id:'tab'
    ,where:{'staff_id':stid}
    ,cols: [[ //表头
    	{type: 'checkbox', fixed: 'left'}
      ,{field: 'cDCCode', title: '区域编号', minWidth:100, sort: true}
      ,{field: 'cDCName', title: '区域名称', minWidth:100}
  ...
  table.on('tool(demo)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
    ...
    if(layEvent === 'detail'){
      layer.msg('查看操作');
        ...
        var cDCCode=data.cDCCode;
        $.ajax({
        	url : "../System/insertNoArea.action",
        	type : "post",
        	data : {'staff_id':stid,'cDCCode':cDCCode},
        	dataType : "JSON",
