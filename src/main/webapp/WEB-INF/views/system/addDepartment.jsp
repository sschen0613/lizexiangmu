    ...
    <form class="layui-form form_revise">
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input placeholder="请输入部门名称" type="text" name="department_Name"  autocomplete="off" class="layui-input" lay-verify="required" >
		    </div>
		  </div>
		  <div class="layui-form-item">
		...
		form.on('submit(submission)', function(data){
			...
			var data2 = data.field //当前容器的全部表单字段，名值对形式：{name: value
		 	...
		 	$.ajax({
		 		...
		 		,type : "post"
		 		,data : {"department_Name" :department_Name, "superior_Id" :superior_Id,"company_Id" :company_Id}
		 		,dataType : "JSON"
