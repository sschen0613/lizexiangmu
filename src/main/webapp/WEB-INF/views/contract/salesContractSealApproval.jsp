...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						//,{field: 'currency_int4', title: '合同版本', minWidth:100}
					...
					if(layEvent === 'detail'){ //查看
						...
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=34"//iframe的url
						}); 
						...
						layer.open({
							...
							maxmin: true,
							area: ['30%', '40%'],
							content: 'Currency/approvalOpinion.action?approval_id=34&currency_id='+data.currency_id
						});
					}
				});
