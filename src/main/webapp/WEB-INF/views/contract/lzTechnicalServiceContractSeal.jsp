...
<!-- 				</div> -->
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">丽泽技术服务合同盖章申请单</button>
			</div>
		</script>
...
// 				});
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=36' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '丽泽技术服务合同盖章申请'
// 			    	,totalRow: true //开启合计行
...
// 						,{field: 'department_name', title: '申请部门', minWidth:100}
					...
					//	,{field: 'currency_int4', title: '合同版本', minWidth:100, templet:'<div>{{d.currency_int4 == "1" ? "我方" : "对方"}}</div>'}
						...
						,{field: 'currency_string8', title: '名称', minWidth:100}
						,{field: 'currency_string9', title: '条件', minWidth:100}
					//	,{field: 'currency_int7', title: '金额', minWidth:80}
						...
						,{field: '', title: '其它特殊约定', minWidth:200}
					...
					switch(obj.event){
						case 'add':
							layer.open({
								type: 2,
								// skin:'layui-layer-molv', //layui-layer-lan
								title: '丽泽技术服务合同盖章申请单填写',
								//shadeClose: true,
								shade: 0.8,
								maxmin: true,
								area: ['80%', '80%'],
								content: 'contract/lzTechnicalServiceContractSealForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
