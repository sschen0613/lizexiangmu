	 		...
	 		<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="text" name="staff_name" required  lay-verify="" placeholder="请输入申请人" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label label-revise">申请部门 :</label>
					<div class="layui-input-block select-revise">
						<select id="department" name="department_name" lay-verify="" lay-search class="select-revise">
...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						,{field: '', title: '客户编码', minWidth:100}
						,{field: '', title: '客户名称', minWidth:100}
						,{field: 'currency_string2', title: '所属区域', minWidth:150}
						,{field: '', title: '合同编码', minWidth:100}
						,{field: '', title: '合同名称', minWidth:100}
						,{field: '', title: '合同类型', minWidth:100}
						,{field: '', title: '合同总金额', minWidth:110}
						,{field: '', title: '已收金额', minWidth:100}
						,{field: '', title: '未收金额', minWidth:100}
						,{field: '', title: '逾期欠款金额', minWidth:120}
						,{field: '', title: '申请减免金额', minWidth:120}
						,{field: '', title: '批准减免金额', minWidth:120}
						,{field: '', title: '合同期间', minWidth:100}
						,{field: '', title: '减免说明', minWidth:200}
					...
					if(layEvent === 'detail'){ //查看
						...
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=2"//iframe的url
						}); 
						...
						layer.open({
							...
							maxmin: true,
							area: ['30%', '40%'],
							content: 'Currency/approvalOpinion.action?approval_id=2&currency_id='+data.currency_id
						});
					}
				});
