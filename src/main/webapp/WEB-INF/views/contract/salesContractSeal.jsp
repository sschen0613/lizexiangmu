	...
	<body>
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">丽泽销售合同盖章申请单</button>
			</div>
		</script>
		...
		//一般直接写在一个js文件中
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=34' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '丽泽销售合同盖章申请'
// 			    	,totalRow: true //开启合计行
...
// 						,{field: 'currency_string3', title: '合同编号', minWidth:100, sort: true}
						...
						,{field: 'currency_string9', title: '条款内容', minWidth:200}
...
// 						,{field: 'details_string4 ', title: '库存编码', minWidth:100, sort: true}
