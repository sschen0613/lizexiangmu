...
<html>
	...
	<body>
		...
		<table class="layui-table table-open">
			<thead>
				<tr>
					<th colspan=9 class="table-h">丽泽技术服务合同盖章申请单</th>
				</tr>
			</thead>
			<tbody>
				<tr>
				...
				<tr>
					...
					<td colspan=7><input type="text" name="condition" lay-verify="required|validateChinese"></td>
				</tr>
				<tr>
                    <td colspan="3">合同签订日期</td>
                    <td colspan="3">合同开始日期</td>
                    <td colspan="3">合同结束日期</td>
                </tr>
                <tr>
					<td colspan=3><input type="text" name="predictGetsum_date" class="layui-input date-revise" id="date1" placeholder="请选择日期" lay-verify="required"></td>
					<td colspan=3><input type="text" name="contract_start_date" class="layui-input" id="date2" placeholder="请选择开始日期" lay-verify="required"></td>
					<td colspan=3><input type="text" name="contract_end_date" class="layui-input" id="date3" placeholder="请选择结束日期" lay-verify="required"></td>
				</tr>
				<tr>
					<td>其它特殊约定</td>
					<td colspan=8><input type="text" name="special_terms"></td>
				</tr>

				<tr>
					<th colspan="9" style="text-align: center;">合同内容</th>
				</tr>

				<tr>
					<td colspan="5">合同内容</td>
					<td colspan="3">金额</td>
					<td colspan="1">操作</td>
				</tr>
				<tr class="test_details">
					<td colspan="5"><input type="text" name="test_content" class="layui-input" lay-verify="required"></td>
		 	...
		 	<thead>
			<tr>
				<td colspan=9 style="text-align: center;" class="addTestDetails"><span class="layui-icon layui-icon-add-1" title="添加检测内容"></span></td>
			</tr>
			<tr>
				<td colspan=5>合计</td>
		...
		//一般直接写在一个js文件中
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
        		...
        		form.on('select(customer_name)', function(data){
					...
					console.log(cCusPPerson);
					console.log(cCusDepart);
    				...
    				$.ajax({
    					...
    					dataType:'JSON',
    					success:function(res){
    		 				var html = '<option value="">请选择技术合同编号</option>';
    						$.each(res.data,function(index,item){
