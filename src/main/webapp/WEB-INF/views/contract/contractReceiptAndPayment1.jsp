...
<script>
    ...
    layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
        ...
        form.on('submit(out)', function(data){
            ...
            var url = 'Currency/selectContractStatement.action?currency_string6=02';
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    // 3. 执行导出函数，系统会弹出弹框
                    LAY_EXCEL.exportExcel(data, '运营类合同报表.xlsx', 'xlsx');
                }
            });
        ...
        var tableInner = table.render({
            elem: '#tab'
            ,url: 'Currency/selectContractStatement.action?currency_string6=02' //数据接口
            ,page: true //开启分页
            ,toolbar: '#toolbarDemo'
            ,title: '合同报表'
// 			,totalRow: true //开启合计行
