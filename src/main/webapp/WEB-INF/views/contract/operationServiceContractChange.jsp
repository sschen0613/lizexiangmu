...
<!-- 						<input type="text" name="applicant" required  lay-verify="" placeholder="请输入申请人" autocomplete="off" class="layui-input input-revise"> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 				<div class="layui-inline"> -->
...
<!-- 				</div> -->
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">丽泽运维合同变更（减免）申请单</button>
			</div>
		</script>
...
// 						,{field: 'department_name', title: '申请部门', minWidth:100}
						...
						,{field: 'currency_string4', title: '客户编码', minWidth:100}
						,{field: 'currency_string5', title: '客户名称', minWidth:200}
						,{field: 'currency_string3', title: '合同编号', minWidth:100, sort: true}
						,{field: 'contract_name', title: '合同名称', minWidth:100} 
						,{field: 'contract_versons', title: '合同类型', minWidth:100, templet:'<div>{{d.contract_versons == "1" ? "运维" :d.contract_versons == "2" ? "BO":"其他"}}</div>'} 
						,{field: 'contract_amount', title: '合同总金额', minWidth:110} 
						,{field: 'received_amount', title: '已收金额', minWidth:100} 
						,{field: 'outstanding_amount', title: '未收金额', minWidth:100}
						,{field: 'overdue_amount', title: '逾期欠款金额', minWidth:120}
						,{field: 'applyReduction_amount', title: '申请减免金额', minWidth:120}
						,{field: 'ratifyReduction_amount', title: '批准减免金额', minWidth:120}
						,{field: 'contract_date', title: '合同期间', minWidth:100}
						,{field: 'subtract_explain', title: '减免说明', minWidth:200}
					...
					switch(obj.event){
						case 'add':
							layer.open({
								type: 2,
								// skin:'layui-layer-molv', //layui-layer-lan
								title: '丽泽运维合同变更（减免）申请单填写',
								//shadeClose: true,
								shade: 0.8,
								maxmin: true,
								area: ['80%', '80%'],
								content: 'contract/operationServiceContractChangeForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
