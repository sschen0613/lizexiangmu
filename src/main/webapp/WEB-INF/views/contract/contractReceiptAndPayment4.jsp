...
<script>
    ...
    layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
        ...
        form.on('submit(out)', function(data){
            ...
            var url = 'Currency/selectXZContractStatement.action?currency_string6=03';
        ...
        var tableInner = table.render({
            elem: '#tab'
            ,url: 'Currency/selectXZContractStatement.action?currency_string6=03'//数据接口
            ,page: true //开启分页
            ,toolbar: '#toolbarDemo'
            ,title: '合同报表'
// 			,totalRow: true //开启合计行
            ,cols: [[ //表头
                ...
                ,{field: 'cDefine28', title: '检测合同内容描述', minWidth:200, sort:true}
