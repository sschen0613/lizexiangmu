...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						/*,{field: 'currency_string', title: '备注说明', minWidth:100}*/
						,{field: 'currency_int2', title: '服务类型', minWidth:100, templet:'<div>{{d.currency_int2=="1" ? "一次性服务" : "按合同期间"}}</div>'}
						,{field: 'currency_string14', title: '合同期间', minWidth:100}
						,{field: 'currency_money', title: '合同金额', minWidth:100}
						,{field: 'currency_string13', title: '合同金额大写', minWidth:120}
						/*,{field: '', title: '合同版本', minWidth:100}
						,{field: '', title: '合同编号', minWidth:100}*/
						,{field: 'currency_int6', title: '付款方式', minWidth:100, templet:'<div>{{d.currency_int6=="1" ? "一次性付款" : d.currency_int6=="2" ? "阶段付款" : "其他"}}</div>'}
						,{field: 'currency_string8', title: '条款名称', minWidth:80}
						,{field: 'currency_string9', title: '条款内容', minWidth:80}
						/*,{field: '', title: '金额', minWidth:80}*/
						,{field: 'currency_date2', title: '合同签订日期', minWidth:120, sort: true, templet:'<div>{{ Format(d.currency_date2,"yyyy-MM-dd")}}</div>'}
						//,{field: 'currency_string12', title: '检测内容', minWidth:100}
					...
					if(layEvent === 'detail'){ //查看
						...
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=47"//iframe的url
						}); 
						...
						layer.open({
							...
							maxmin: true,
							area: ['30%', '40%'],
							content: 'Currency/approvalOpinion.action?approval_id=47&currency_id='+data.currency_id
						});
					}
				});
