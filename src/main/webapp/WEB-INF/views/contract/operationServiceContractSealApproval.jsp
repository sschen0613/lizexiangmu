...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						,{field: 'currency_money6', title: '合同金额', minWidth:100}
...
//						,{field: '', title: '金额', minWidth:80}
						...
						,{field: 'currency_string', title: '配件特殊约定', minWidth:120}
						,{field: 'currency_string15', title: '检测比对约定', minWidth:120}
						,{field: 'currency_string10', title: '其它特殊约定', minWidth:120}
					...
					if(layEvent === 'detail'){ //查看
						...
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=35"//iframe的url
						}); 
						...
						layer.open({
							...
							maxmin: true,
							area: ['30%', '40%'],
							content: 'Currency/approvalOpinion.action?approval_id=35&currency_id='+data.currency_id
						});
					}
				});
