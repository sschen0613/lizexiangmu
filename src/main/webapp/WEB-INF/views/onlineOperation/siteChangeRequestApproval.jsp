...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						,{field: 'currency_string4', title: '客户名称', minWidth:100}
						,{field: 'currency_string3', title: '合同编号', minWidth:100}
						,{field: 'currency_string8', title: '在线运维部交接人', minWidth:140}
						,{field: 'currency_date2', title: '交接日期	', minWidth:100, templet:'<div>{{ Format(d.currency_date,"yyyy-MM-dd")}}</div>'}
					...
					if(layEvent === 'detail'){ //查看
						...
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=39"//iframe的url
						}); 
						...
						layer.open({
							...
							maxmin: true,
							area: ['30%', '40%'],
							content: 'Currency/approvalOpinion.action?approval_id=39&currency_id='+data.currency_id
						});
					}
				});
