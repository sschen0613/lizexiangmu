	...
	<body>
	 	<form class="layui-form form-top" action="">
	 		<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="text" name="currency_string4" placeholder="客户名称 :" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
			  	<div class="layui-inline">
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">添加丽泽运营站点变更交接申请表</button>
			</div>
		</script>
...
// 				});
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=39' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '丽泽运营站点变更交接申请表'
...
// 						,{field: 'proposer_department', title: '申请部门', minWidth:100} 
						...
						,{field: 'currency_string2', title: '县区', minWidth:150}
						,{field: 'currency_string5', title: '区域负责人', minWidth:110}
						,{field: 'currency_string4', title: '客户名称', minWidth:200}
						,{field: 'currency_string3', title: '合同编号', minWidth:100}
						,{field: 'currency_string8', title: '在线版运维部交接人', minWidth:150}
						,{field: 'currency_date2', title: '交接日期', minWidth:100, sort: true,templet:'<div>{{ Format0(d.currency_date,"yyyy-MM-dd HH:mm:ss")}}</div>'}
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								shadeClose: true,
								area: ['80%', '80%'],
								content: 'onlineOperation/siteChangeRequestForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
