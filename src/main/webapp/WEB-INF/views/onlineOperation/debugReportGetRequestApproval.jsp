...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						,{field: 'currency_string5', title: '企业名称', minWidth:100}
						,{field: 'currency_string12', title: '设备名称', minWidth:100}
						,{field: 'currency_string7', title: '申请事由', minWidth:100}
						,{field: 'currency_string11', title: '备注', minWidth:200}
					...
					if(layEvent === 'del'){ //删除
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=37"//iframe的url
						}); 
						...
						layer.open({
							...
							maxmin: true,
							area: ['30%', '40%'],
							content: 'Currency/approvalOpinion.action?approval_id=37&currency_id='+data.currency_id
						});
					}
				});
