	...
	<div class="layui-form-item">
		<div class="layui-inline">
			...
			<div class="layui-input-block">
				<input name="currency_date2" type="text" class="layui-input input-revise date-revise" id="date1" placeholder="请选择申请开始日期">
			</div>
		</div>
		<div class="layui-inline">
			<label class="layui-form-label label-revise">结束日期 :</label>
			<div class="layui-input-block">
				<input name="currency_date3" type="text" class="layui-input input-revise date-revise" id="date2" placeholder="请选择申请结束日期">
			</div>
		</div>
		<div class="layui-inline">
...
<script type="text/html" id="toolbarDemo">
	<div class="layui-btn-container">
		<button class="layui-btn layui-btn-xs" lay-event="add">添加技术支持性检测任务申请表</button>
	</div>
</script>
...
//                 });
        ...
        var tableInner = table.render({
            elem: '#tab'
            ,url: 'Currency/selectApplicantCurrency.action?currency_type=41' //数据接口
            ,page: true //开启分页
            ,toolbar: '#toolbarDemo'
            ,title: '技术支持性检测任务申请表'
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'currency_string2', title: '客户名称', minWidth:150}
                //,{field: 'currency_string5', title: '区域', minWidth:150}
                ,{field: 'currency_date3', title: '计划检测日期', minWidth:120, sort: true, templet:'<div>{{ Format(d.currency_date3,"yyyy-MM-dd")}}</div>'}
                ,{field: 'currency_date2', title: '计划完成日期', minWidth:140, templet:'<div>{{ Format(d.currency_date2,"yyyy-MM-dd")}}</div>'}
                ,{field: 'currency_string8', title: '检测类型', minWidth:120}
                ,{field: 'currency_string7', title: '采样类型', minWidth:100}
            ...
            switch(obj.event){
                case 'add':
                    layer.open({
                        ...
                        shadeClose: true,
                        area: ['80%', '80%'],
                        content: 'onlineOperation/technicalSupportDetectionForm.action' //iframe的url
                    });
                    break;
                case 'delete':
                    layer.msg('删除');
