...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						,{field: 'currency_string5', title: '异常时间段', minWidth:110}
						,{field: 'currency_string7', title: '异常情况描述', minWidth:100}
                        ,{field: 'currency_string10', title: '备注', minWidth:100}
					...
					if(layEvent === 'del'){ //删除
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=42"//iframe的url
						}); 
						...
						layer.open({
							...
							maxmin: true,
							area: ['30%', '40%'],
							content: 'Currency/approvalOpinion.action?approval_id=42&currency_id='+data.currency_id
						});
					}
				});
