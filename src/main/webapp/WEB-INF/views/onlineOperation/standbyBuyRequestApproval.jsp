	 		...
	 		<div class="layui-form-item">
	 			<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="text" name="currency_number" placeholder="请输入请购单号" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
				<div class="layui-inline">
...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						,{field: 'currency_string2', title: '请购区域', minWidth:100}
						...
						,{field: 'currency_string5', title: '技术要求', minWidth:100}
						,{field: 'currency_string8', title: '其它说明', minWidth:100}
					...
					if(layEvent === 'detail'){ //查看
						...
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=40"//iframe的url
						}); 
						...
						layer.open({
							...
							maxmin: true,
							area: ['30%', '40%'],
							content: 'Currency/approvalOpinion.action?approval_id=40&currency_id='+data.currency_id
						});
					}
				});
