...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <button class="layui-btn layui-btn-xs" lay-event="add">添加标气申购申请单</button>
    </div>
</script>
...
<script>
    ...
    layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
        ...
        var tableInner = table.render({
            elem: '#tab'
            ,url: 'Currency/selectApplicantCurrency.action?currency_type=55' //数据接口
            ,page: true //开启分页
            ,toolbar: '#toolbarDemo'
            ,title: '备机请购申请单'
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'currency_string10', title: '请购区域', minWidth:150}
            ...
            switch(obj.event){
                case 'add':
                    layer.open({
                        ...
                        shadeClose: true,
                        area: ['80%', '80%'],
                        content: 'onlineOperation/standardGasRequestForm.action' //iframe的url
                    });
                    break;
                case 'delete':
                    layer.msg('删除');
