...
<html>
	...
	<body>
		...
		<table class="layui-table table-open">
			<thead>
				<tr>
					<th colspan="7" class="table-h">安装调试申请表</th>
				</tr>
				<tr>
	 				<th colspan=7 style="text-align:right">流水号：<input type="text" id='buy_number' name="flow_number"> </th>
				</tr>
		 	</thead>
		 	<tbody >	 		
		 		<tr>
		 		...
		 		<tr>
		 			<td>申请事由</td>
		 			<td colspan=7><input type="text" name="proposer_reason" placeholder="请务必填写申请事由" lay-verify="required"></td>
		 		</tr>
		 		<tr>	
					<td>企业名称</td>
					<td>设备名称</td>
			...
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
				...
				//监听提交按钮
              	form.on('submit(submitForm)', function(data){
					...
					var flow_number = data.field.flow_number;
