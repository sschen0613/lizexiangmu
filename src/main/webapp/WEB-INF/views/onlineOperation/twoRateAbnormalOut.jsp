	...
	<body>
	 	<form class="layui-form form-top" action="">
	 		<div class="layui-form-item">
				...
				<%--<div class="layui-inline">
					<label class="layui-form-label label-revise">设备类型 :</label>
					<div class="layui-input-block">
						<input type="text" name="currency_string8" placeholder="设备类型 :" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>--%>
			  	<div class="layui-inline">
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">添加两率异常剔除申请流程单</button>
			</div>
		</script>
...
// 				});
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=42'
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '两率异常剔除申请流程单'
...
// 						,{field: 'proposer_department', title: '申请部门', minWidth:100}
						...
						,{field: 'currency_string3', title: '运维人', minWidth:80}
						,{field: 'currency_string4', title: '站点名称', minWidth:100}
						,{field: 'currency_string8', title: '剔除项目', minWidth:100}
						,{field: 'currency_string9', title: '责任部门', minWidth:100}
						,{field: 'currency_string5', title: '异常时间段', minWidth:300}
						,{field: 'currency_string7', title: '异常情况描述', minWidth:200}
                        ,{field: 'currency_string10', title: '备注', minWidth:200}
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								shadeClose: true,
								area: ['80%', '80%'],
								content: 'onlineOperation/twoRateAbnormalOutForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
