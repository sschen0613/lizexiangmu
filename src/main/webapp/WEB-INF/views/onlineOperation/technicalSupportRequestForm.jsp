...
<html>
	...
	<body>
		...
		<table class="layui-table table-open">
			<thead>
				<tr>
					<th colspan="7" class="table-h">技术支持申请表</th>
				</tr>
				<tr>
	 				<th colspan=7 style="text-align:right">流水号：<input type="text" id='buy_number' name="buy_number"> </th>
				</tr>
		 	</thead>
		 	<tbody >	 		
		 		<tr>
				...
				<tr class="details">
					<td><select name="enterprise_name" id="enterprise1" lay-filter="enterprise" lay-search lay-verify="required"></select></td>
					...
					<td><input type="text" name="problem_describe"></td>
			...
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
				...
				$('.addDetails').click(function(){
					...
					var html = '<tr class="details">'
                        	 +	'<td><select name="enterprise_name" id="enterprise'+d_count+'" lay-filter="enterprise" lay-search lay-verify="required">'+enterprise_name_html+'</select></td>'
				 			 +	'<td><input type="text" name="equipment_name"></td>'
				 			 +	'<td><input type="text" name="specifications_models"></td>'
				 			 +	'<td><input type="text" name="service_character"></td>'
				 			 +	'<td><input type="text" name="problem_describe"></td>'
