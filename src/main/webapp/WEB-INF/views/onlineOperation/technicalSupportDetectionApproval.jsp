...
<script>
    ...
    layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
        ...
        form.on('submit(out)', function(data){
            ...
            var url = 'Currency/selectCurrencyApprover2.action?currency_type=41&currency_string='+staffid;
            if (date1 != null && date1 != ''){
...
// 			    	,totalRow: true //开启合计行
            ,cols: [[ //表头
                ...
                ,{field: 'currency_string2', title: '客户', minWidth:150}
        ...
        table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'del'){ //删除
                layer.open({
                    ...
                    +data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=41"//iframe的url
                });
                ...
                layer.open({
                    ...
                    maxmin: true,
                    area: ['30%', '40%'],
                    content: 'Currency/approvalOpinion.action?approval_id=41&currency_id='+data.currency_id
                });
            }
        });
