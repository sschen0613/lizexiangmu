	...
	<body>
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">水样检测申请表</button>
			</div>
		</script>
...
// 				});
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=66' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '技术支持申请表'
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								shadeClose: true,
								area: ['80%', '80%'],
								content: 'onlineOperation/waterDetectionRequestForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
