...
<script>
    ...
    layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
        ...
        form.on('submit(out)', function(data){
            ...
            var url = 'Currency/selectCurrencyApprover2.action?currency_type=55&currency_string='+staffid;
            if (date1 != null && date1 != ''){
            ...
            $.ajax({
                ...
                success: function(res) {
                    var data = LAY_EXCEL.filterExportData(res.data, {
                        ...
                        details_string10:"details_string10",
                        details_string7:"details_string7",
                        details_money:"details_money",
                        details_string11:"details_string11"
                    });
                    data.unshift({
                        currency_number: '编号',staff_name:"申请人",department_name:"申请部门",currency_date: '申请日期',currency_string10:"请购区域",
                        currency_date2: '需求日期',
                        details_string8:"区域名称",details_string5:"企业站点名称",details_string9:"标气类型",details_string10:"浓度",
                        details_string7:"单位",details_money:"数量",details_string11:"备注"
                    });
                    // 3. 执行导出函数，系统会弹出弹框
                    LAY_EXCEL.exportExcel(data, '标气申请.xlsx', 'xlsx');
                }
            });
        ...
        var tableInner = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'currency_date2', title: '需求日期	', minWidth:100, templet:'<div>{{ Format(d.currency_date2,"yyyy-MM-dd")}}</div>'}
        ...
        table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){ //查看
                ...
                layer.open({
                    ...
                    +data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=55"//iframe的url
                });
                ...
                layer.open({
                    ...
                    maxmin: true,
                    area: ['30%', '50%'],
                    content: 'Currency/approvalOpinion.action?approval_id=55&currency_id='+data.currency_id
                });
            }
        });
