	...
	<body>
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">信泽设备维修申请单</button>
			</div>
		</script>
...
// 				});
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=16' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '信泽设备维修申请'
// 			    	,totalRow: true //开启合计行
...
// 						,{field: 'department_name', title: '申请部门', minWidth:100}
						...
						,{field: 'currency_string7', title: '故障描述', minWidth:200}
						,{field: 'currency_string8', title: '技术要求', minWidth:200}
						,{field: 'currency_string9', title: '其它说明', minWidth:200}
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								maxmin: true,
								area: ['80%', '80%'],
								content: 'storage/equipmentMaintenanceForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
