...
<div id="content" class="content">
    ...
    <div class="title"><h2>信泽实验室设备及资产采购申请详情<i id="number0"></i></h2></div>
    <table border="1" class="layui-table">
        ...
        <tr>
            <td>申请事由</td>
            <td id="applyReason" colspan="1"></td>
            <td>技术要求</td>
            <td id="technology" colspan="2"></td>
            <td>其他说明</td>
            <td id="orther" colspan="2"></td>
        </tr>
        <tr class="details">
            <td>设备名称</td>
...
<script>
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            $("#applyReason").text(res.data[0].currency_string7);
            $("#technology").text(res.data[0].currency_string8);
            $("#orther").text(res.data[0].currency_string9);
