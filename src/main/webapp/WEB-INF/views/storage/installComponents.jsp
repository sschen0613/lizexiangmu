	...
	<body>
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">安装组配件采购单</button>
			</div>
		</script>
...
// 						,{field: 'department_name', title: '申请部门', minWidth:100}
                        ...
                        ,{field: 'currency_string2', title: '使用区域', minWidth:80}
 						,{field: 'currency_string3', title: '使用部门', minWidth:100}
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								maxmin: true,
								area: ['80%', '80%'],
								content: 'storage/installComponentsForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
