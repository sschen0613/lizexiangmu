	 	...
	 	<form class="layui-form form-top" action="">
	 		<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="text" name="currency_string3" placeholder="请输入销售合同编号" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
			  	<div class="layui-inline">
		...
		//一般直接写在一个js文件中
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
                ...
                form.on('submit(out)', function(data){
                    ...
                    var currency_string3 = $('input[name="currency_string3"]').val();
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            data.unshift({
                                ...
                                currency_string7: '客户名称',currency_string3: '合同编号',currency_date2: '期望到货日期',currency_money: '合同金额',
                                currency_money2: '收款金额',currency_money3: '未收金额',
                                details_string5:"存货编码",details_string4:"商品名称", details_string6:"规格型号",details_string7:"单位",details_money2:"合同数量",
				...
				table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
					...
					if(layEvent === 'detail'){ //查看
						layer.open({
                            ...
                            content: 'storage/requisitionsOfSaleSuppliesApprovalDetail.action?currency_id='+data.currency_id+'&currency_type='+data.currency_type
						});
						...
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type="+data.currency_type//iframe的url
						}); 
                        ...
                        layer.open({
                            ...
                            maxmin: true,
                            area: ['80%', '80%'],
                            content: 'storage/requisitionsOfSaleSuppliesApprovalPrint.action?currency_id='+data.currency_id+'&currency_type='+data.currency_type
                        });
