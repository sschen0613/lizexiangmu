...
<html>
	...
	<body>
		...
		<table class="layui-table table-open">
			<thead>
				<tr>
					<th colspan=7 class="table-h">信泽实验室常规请购申请单</th>
				</tr>
				<tr>
			...
			<tbody>
				...
				<tr>
					<td>技术要求</td>
					<td colspan=6><input type="text" name="technical_requirementsvarchar" placeholder="请务必填写技术要求" lay-verify="required"></td>
				</tr>
				<tr>
					<td>其它说明</td>
				...
				<tr class="details">
					...
					<td><input type="text" name="product_manufacturer" readonly></td>
				...
				//监听提交按钮
              	form.on('submit(submitForm)', function(data){
					...
					$.each($('.details'),function(index,item){
						...
						var obj = {'product_name':product_name,'product_manufacturer':product_manufacturer,'specifications_models':specifications_models
								,'unit':unit,'buy_quantity':buy_quantity,'remark':remark};
							...
							success:function (res) {
								...
								$.each(res.data,function(index,item){
									...
									var html = '<tr class="details">'
							             ...
							             +		'</div>'
										 +	'</td>'
							 			 +	'<td><input type="text" name="product_manufacturer" value="'+item.details_string8+'" readonly></td>'
