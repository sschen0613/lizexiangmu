...
<html>
	...
	<body>
		...
		<table class="layui-table table-open">
			<thead>
				<tr>
					<th colspan=9 class="table-h">安装组配件采购单</th>
				</tr>
				<tr>
	 				<th colspan=9 style="text-align:right">采购单号：<input type="text" id='buy_number' name="buy_number" readonly> </th>
				</tr>
		 	</thead>
		 	<tbody >
		 		<tr>
		 			<td>说明</td>
		 			<td colspan=8><input type="text" name="illustration" value="用于信泽公司安装组配件请购" readonly></td>
		 		</tr>
		 		<tr>
		 		...
		 		<tr>
					<td>使用区域</td>
					<td colspan=2><input type="text" name="area" id="area" readonly></td>
					<td>使用企业</td>
					<td colspan=2><input type="text" name="company" id="company" readonly></td>
		 			<td>期望到货日期</td>
		 			<td colspan=2><input name="expectedDelivery_date" type="text" class="layui-input date-revise" id="date1" placeholder="请选择日期" autocomplete="off"></td>
		 		</tr>
		 		<tr>
							...
							success:function (res) {
								...
								$.each(res.data,function(index,item){
									...
									var html = '<tr class="details">'
							 			 ...
							 			 +	'<td id="container'+d_count+'" class="container container'+d_count+'">'
										 +		'<input id="product_name" name="product_name" value="'+item.details_string3+'" class="search-box" placeholder="输入关键字查询" lay-verify="required">'
										 +		'<div class="list-container" style="display:none;">'
							             +   		'<ul></ul>'
							             +		'</div>'
										 +	'</td>'
							 			 +	'<td><input type="text" name="specifications_models" value="'+item.details_string7+'" readonly></td>'
							 			 +	'<td><input type="text" name="unit" value="'+item.details_string5+'" readonly></td>'
							 			 +	'<td><input type="text" id="buy_quantity'+d_count+'" name="buy_quantity" value="'+item.details_money+'" lay-verify="required"></td>'
							 			 +	'<td><input type="text" name="inventory_quantity" value="'+item.details_money3+'" readonly></td>'
							 			 +	'<td><input type="text" name="recent_price" value="'+item.details_money4+'" readonly></td>'
							 			 +	'<td class="delete'+d_count+'"><button type="button" class="layui-btn layui-btn-danger layui-btn-xs">删除</button></td>'
							 			 +	'</tr>';
									$('table.table-open>tbody').append(html);
									//渲染
