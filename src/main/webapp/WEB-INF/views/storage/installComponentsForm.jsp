		...
		<table class="layui-table table-open">
			<thead>
		 	...
		 	<tbody >
		 		<tr>
		 			<td>说明</td>
		 			<td colspan=8><input type="text" name="illustration" value="用于信泽公司安装组配件采购" readonly></td>
		 		</tr>
		 		<tr>
		 		...
		 		<tr>
					<td>使用区域</td>
					<td colspan=2><input type="text" name="area" id="area"></td>
					<td>使用企业</td>
					<td colspan=2><input type="text" name="company" id="company"></td>
		 			<td>期望到货日期</td>
		 			<td colspan=2><input name="expectedDelivery_date" type="text" class="layui-input" id="date1" placeholder="请选择日期" autocomplete="off"></td>
		 		</tr>
		 		<tr>
		 		...
		 		<tr class="details">
					...
					<td colspan="2"><input id='product_name' name="product_name" lay-verify="required"></td>
			...
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
				...
				//监听提交按钮
              	form.on('submit(submitForm)', function(data){
                    ...
                    var area = data.field.area; //使用区域
                    var company = data.field.company; //使用企业
				...
				$('.addDetails').click(function(){
					...
					var html = '<tr class="details">'
				 			 ...
				 			 +	'<td colspan="2" id="container'+d_count+'" class="container container'+d_count+'">'
							 +		'<input id="product_name" name="product_name"  lay-verify="required">'
							 +	'</td>'
				 			 +	'<td colspan="2"><input type="text" name="specifications_models"></td>'
