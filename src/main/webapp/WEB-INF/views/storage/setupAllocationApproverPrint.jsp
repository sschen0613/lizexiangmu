...
<div id="content" class="content">
    ...
    <div class="title"><h2>普通运营请购申请详情<i id="number0"></i></h2></div>
...
<script>
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            $("#expectedDelivery_date").text(Format(res.data[0].currency_date3,"yyyy-MM-dd"));
        ...
        success:function(res){
            $.each(res.data,function (index,item) {
                ...
                html += '<td>'+item.details_string5+'</td>'
                    +	'<td colspan="2">'+item.details_string4+'</td>'
                    +	'<td colspan="2">'+item.details_string6+'</td>'
                    +	'<td colspan="2">'+item.details_string7+'</td>'
//                    +	'<td>'+item.details_money2+'</td>'
                    +	'<td colspan="2">'+item.details_money+'</td>'
