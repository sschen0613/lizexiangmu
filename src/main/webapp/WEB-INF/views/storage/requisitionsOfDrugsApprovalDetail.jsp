...
<div id="content" class="content">
    ...
    <div class="title"><h2>药品采购申请详情<i id="number0"></i></h2></div>
    <table border="1" class="layui-table">
        ...
        <tr>
            ...
            <td id="apply_reason" colspan="6"></td>
        </tr>
        <tr>
            <td colspan="2">技术要求</td>
            <td id="technical_requirementsvarchar" colspan="6"></td>
        </tr>
        <tr>
            <td colspan="2">其它说明</td>
            <td id="other_description" colspan="6"></td>
        </tr>
        <tr>
...
<script>
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            $("#technical_requirementsvarchar").text(res.data[0].currency_string8);
            $("#other_description").text(res.data[0].currency_string9);
        }
    });
    ...
    $.ajax({
        ...
        success:function(res){
            $.each(res.data,function (index,item) {
                var html = '<tr>';
                html += '<td colspan="2">'+item.details_string2+'</td>'
