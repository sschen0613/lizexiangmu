...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						,{field: 'currency_string10', title: '客户名称', minWidth:150}
				...
				table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
					...
					if(layEvent === 'detail'){ //查看
						layer.open({
                            ...
                            content: 'storage/outlibraryOfMaterialClassApprovalDetail.action?currency_id='+data.currency_id+'&currency_type='+data.currency_type
                        });
