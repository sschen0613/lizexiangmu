...
// 						,{field: '', title: '发货类型', minWidth:100}
                ,{field: 'currency_date2', title: '期望到货日期', minWidth:120, templet:'<div>{{ Format(d.currency_date2,"yyyy-MM-dd")}}</div>'}
                //,{field: 'currency_date3', title: '预计到货日期', minWidth:120, templet:'<div>{{ Format(d.currency_date3,"yyyy-MM-dd")}}</div>'}
// 						,{field: '', title: '物资部库管员确认入库', minWidth:160}
        ...
        table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){ //查看
                ...
                layer.open({
                    ...
                    +data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=9"//iframe的url
                });
                ...
                layer.open({
                    ...
                    maxmin: true,
                    area: ['30%', '50%'],
                    content: 'Currency/approvalOpinion.action?approval_id=9&currency_id='+data.currency_id
                });
            }
        });
