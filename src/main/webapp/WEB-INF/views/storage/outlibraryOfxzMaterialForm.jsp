			...
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
				...
				//监听提交按钮
              	form.on('submit(submitForm)', function(data){
					...
					var cangkuId = data.field.cangku
					var cangkuName = $('#cangku').find('option:selected').text();
					...
					$.each($('.details'),function(index,item){
						...
						var obj = {'details_string4':inventory_id,'details_string5':product_name,'details_string6':specifications_models
								,'details_string7':unit,'details_string9':cangkuId,'details_money':buy_quantity,'details_money2':inventory_quantity,'details_string11':remark};
				 	...
				 	$.ajax({
				 		...
				 		,data : {'currency_number':buy_number ,
                            ...
                            'currency_string8':cangkuName, 
                            'currency_string9':cangkuId, 
        		...
        		// 一:获取仓库
    			$.ajax({
    				url:'System/selectXZCangKu.action',
    				type:'post',
    				dataType:'JSON',
        		...
        		function searchProcess($demo){
                    xzProcessProductByCangkuId($demo);
				}
