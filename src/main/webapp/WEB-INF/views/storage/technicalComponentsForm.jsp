...
<html>
	...
	<body>
		...
		<table class="layui-table table-open">
			<thead>
				<tr>
					<th colspan=9 class="table-h">技术保障部配件采购单</th>
				</tr>
				<tr>
		 	...
		 	<tbody >
		 		<tr>
		 			<td>说明</td>
		 			<td colspan=8><input type="text" name="illustration" value="用于技术保障部配件采购" readonly></td>
		 		</tr>
		 		<tr>
		 		...
		 		<tr>
					...
					<td>申请事由</td>
					<td colspan=5><input type="text" name="area" id="area"></td>
		 		</tr>
		 		<tr>
		 		...
		 		<tr class="details">
					...
					<td colspan="2"><input type="text" id='product_name' name="product_name" lay-verify="required"></td>
					...
					<td><input type="text" id="price1" name="price" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" lay-verify="required"></td>
