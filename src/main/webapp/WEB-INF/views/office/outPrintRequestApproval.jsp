...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						,{field: '', title: '打印地点', minWidth:100}
						,{field: '', title: '打印内容', minWidth:100}
						,{field: '', title: '备注', minWidth:200}
					...
					if(layEvent === 'del'){ //删除
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=32"//iframe的url
						}); 
						...
						layer.open({
							...
							maxmin: true,
							area: ['30%', '50%'],
							content: 'Currency/approvalOpinion.action?approval_id=32&currency_id='+data.currency_id
						});
					}
				});
