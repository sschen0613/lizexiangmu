	 		...
	 		<div class="layui-form-item">
	 			<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="text" name="currency_number" placeholder="请输入流程编号" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
				<div class="layui-inline">
		...
		//一般直接写在一个js文件中
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
                ...
                form.on('submit(out)', function(data){
                    ...
                    var url = 'Currency/selectCurrencyApprover2.action?currency_type=21&currency_string='+staffid;
                    if (date1 != null && date1 != ''){
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            data.unshift({
                                ...
                                currency_date2: '出发日期',currency_string2:"出发地点",currency_string3:"目的地",currency_int2:"用车类型",
                                currency_string4:"驾驶员",currency_string5:"公车车牌号",currency_string9:"私车车牌号",currency_string8:"设备商及人员",currency_string7:"申请事由"
                            });
                            // 3. 执行导出函数，系统会弹出弹框
                            LAY_EXCEL.exportExcel(data, '出发登记.xlsx', 'xlsx');
                        }
                    });
...
// 						,{field: 'currency_number', title: '流程编号', minWidth:200}
						...
						,{field: 'currency_date2', title: '出发日期', sort: true, minWidth:100, templet:'<div>{{ Format(d.currency_date2,"yyyy-MM-dd")}}</div>'}
						,{field: 'currency_string2', title: '出发地点', minWidth:100}
						,{field: 'currency_string3', title: '目的地', minWidth:100}
						,{field: 'currency_int2', title: '用车类型', minWidth:100, templet:'<div>{{d.currency_int2 == "1" ? "公车" : "私家车"}}</div>'}
						,{field: 'currency_string4', title: '驾驶员', minWidth:80}
						,{field: 'currency_string5', title: '公车车牌号', minWidth:110}
						,{field: 'currency_string9', title: '私车车牌号', minWidth:110}
						,{field: 'currency_string8', title: '设备商及人员', minWidth:120}
					...
					if(layEvent === 'del'){ //删除
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=21"//iframe的url
						}); 
						...
						layer.open({
							...
							maxmin: true,
							area: ['30%', '40%'],
							content: 'Currency/approvalOpinion.action?approval_id=21&currency_id='+data.currency_id
						});
					}
				});
