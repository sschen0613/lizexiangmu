	...
	<body>
	 	<form class="layui-form form-top" action="">
	 		<div class="layui-form-item">
				...
				<div class="layui-inline">
					<label class="layui-form-label label-revise">驾驶员 :</label>
					<div class="layui-input-block">
						<input type="text" name="currency_string4" placeholder="驾驶员 :" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
			  	<div class="layui-inline">
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">添加出发登记申请单</button>
			</div>
		</script>
		...
		//一般直接写在一个js文件中
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=21' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '出发登记申请单'
...
// 						,{field: 'department_name', title: '申请部门', minWidth:100}
						...
						,{field: 'currency_string4', title: '驾驶员', minWidth:100}
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								shadeClose: true,
								area: ['80%', '80%'],
								content: 'office/departRegisterRequestForm.action' //iframe的url
							}); 
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
