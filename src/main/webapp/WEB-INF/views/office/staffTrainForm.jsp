...
<html>
	...
	<body>
		...
		<table class="layui-table table-open">
			<thead>
				<tr>
					<th colspan=6 class="table-h">员工培训申请单</th>
				</tr>
				<tr>
			...
			<tbody>
				...
				<tr>
					<td>培训课程</td>
					<td><input type="text" id="train_cource" name="train_cource" class="layui-input" lay-verify="required"></td>
					<td>培训时间</td>
					<td><input name="currency_date2" type="text" class="layui-input date-revise" id="date2" placeholder="请选择日期"></td>
					<td>参加人员</td>
					<td><input type="text" id="participant" name="participant" class="layui-input" lay-verify="required"></td>
				</tr>
				<tr>
					<td>费用明细</td>
					<td colspan="5"><input type="text" id="expense_detail" name="expense_detail" class="layui-input" lay-verify="required"></td>
				</tr>
				<tr>
					<td>备注</td>
		...
		//一般直接写在一个js文件中
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
				...
				form.on('submit(submitForm)', function(data){
					var train_cource = data.field.train_cource;//培训课程
					var currency_date2 = data.field.currency_date2;//培训时间
					var participant = data.field.participant;//参加人员
					var expense_detail = data.field.expense_detail;//费用明细
					var remark = data.field.remark;
					var currency_type = 77;//77是当前审批请求的类型,审批管理主键id;

					var myForm = new FormData();
					myForm.set("currency_type",currency_type);
					myForm.set("currency_string2",train_cource);
					myForm.set("currency_string3",participant);
					myForm.set("currency_string4",expense_detail);
