	 		...
	 		<div class="layui-form-item">
	 			<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="text" name="" placeholder="请输入流程编号" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label label-revise">申请人 :</label>
					<div class="layui-input-block">
						<input type="text" name="staff_name" lay-verify="" placeholder="请输入申请人" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
				<div class="layui-inline">
...
// 			    	,totalRow: true //开启合计行
					,cols: [[ //表头
						...
						,{field: 'currency_string3', title: '车牌号', minWidth:80}
						,{field: 'currency_string4', title: '维修类别', minWidth:100}
						,{field: 'currency_money6', title: '预计金额', minWidth:100}
						,{field: 'currency_string5', title: '维修事由', minWidth:100}
					...
					if(layEvent === 'del'){ //删除
						layer.open({
							...
							content: 'Currency/approvalProgress.action?currency_id='+data.currency_id+"&current_approvalCount="
									+data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=33"//iframe的url
						}); 
