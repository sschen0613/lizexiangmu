	...
	<body>
	 	<form class="layui-form form-top" action="">
	 		<div class="layui-form-item">
				...
				<div class="layui-inline">
					<label class="layui-form-label label-revise">车牌号 :</label>
					<div class="layui-input-block">
						<input type="text" name="currency_string3" placeholder="车牌号 :" autocomplete="off" class="layui-input input-revise">
					</div>
				</div>
			  	<div class="layui-inline">
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">添加车辆维修申请表</button>
			</div>
		</script>
...
// 				});
				...
				var tableInner = table.render({
					elem: '#tab'
					,url: 'Currency/selectApplicantCurrency.action?currency_type=33' //数据接口
					,page: true //开启分页
					,toolbar: '#toolbarDemo'
			    	,title: '车辆维修申请表'
...
// 						,{field: 'department_name', title: '申请部门', minWidth:100}
						...
						,{field: 'currency_string3', title: '车牌号', minWidth:100} //枚举
						,{field: 'currency_string4', title: '维修类型', minWidth:100}//枚举,正常维修,事故维修,轮胎,保养
						,{field: 'currency_money6', title: '预计金额', minWidth:100}
						,{field: 'currency_string5', title: '维修事由', minWidth:200}
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								maxmin: true,
								area: ['80%', '80%'],
								content: 'office/carMaintainRequestForm.action' ,//iframe的url
