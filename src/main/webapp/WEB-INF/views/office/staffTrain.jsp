...
<!-- 		</div> -->
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				<button class="layui-btn layui-btn-xs" lay-event="add">员工培训申请单</button>
			</div>
		</script>
			...
			layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
				...
				table.render({
					...
					,cols: [[ //表头
						...
						,{fixed: 'right', title:'操作', toolbar: '#barDemo', minWidth:220}
					]]
				});
					...
					switch(obj.event){
						case 'add':
							layer.open({
								...
								maxmin: true,
								area: ['80%', '80%'],
								content: 'office/staffTrainForm.action' //iframe的url
							});
				    	break;
				    	case 'delete':
				    		layer.msg('删除');
