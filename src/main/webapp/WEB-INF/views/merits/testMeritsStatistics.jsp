...
<script>
    ...
    layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
        ...
        form.on('submit(out)', function(data){
            ...
            var url = 'Currency/selectAllCurrency.action?currency_type=59';
            if (date1 != null && date1 != ''){
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    data.unshift({
                        ...
                        currency_string7: '内容简述', details_date2:"检测日期", details_string2:"企业名称/样品名称/编号", details_string3:"分析内容",
                        details_money:"数量", details_money2:"绩效单价",details_money3:"绩效金额",details_string11:"备注"
                    });
                    // 3. 执行导出函数，系统会弹出弹框
        ...
        var tableInner = table.render({
            elem: '#tab'
            ,url: 'Currency/selectAllCurrency.action?currency_type='+ currency_type //数据接口
            ,page: true //开启分页
            //,toolbar: true
            ,title: '现场科绩效统计'
            ,totalRow: true //开启合计行
            ,cols: [[ //表头
                ...
                ,{field: 'currency_string7', title: '内容简述', minWidth:100}
                ,{field: 'details_date2', title: '检测日期', minWidth:100, templet:'<div>{{ Format(d.details_date2,"yyyy-MM-dd")}}</div>'}
        ...
        table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){ //查看
                ...
                layer.open({
                    ...
                    +data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=59"//iframe的url
                });
                ...
                layer.open({
                    ...
                    maxmin: true,
                    area: ['30%', '40%'],
                    content: 'Currency/approvalOpinion.action?approval_id=59&currency_id='+data.currency_id
                });
            }
        });
