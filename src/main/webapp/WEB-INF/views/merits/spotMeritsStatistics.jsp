...
<script>
    ...
    layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
        ...
        form.on('submit(out)', function(data){
            ...
            var url = 'Currency/selectAllCurrency.action?currency_type=58';
            if (date1 != null && date1 != ''){
                ...
                success: function(res) {
                    var data = LAY_EXCEL.filterExportData(res.data, {
                        ...
                        details_int3:function (value,line,data) {
                            return value == 1 ? "常规检测" : "在线比对";
                        },
                        details_int4:function (value,line,data) {
                            return value == 1 ? "超低排放" : "非超低排放";
                        },
                    ...
                    data.unshift({
                        ...
                        currency_string7: '采样简述', name: '采样员',details_int3:"检测类型", details_int4:"采样类型", details_money:"数量",
                        money:"绩效金额",details_string11:"备注"
                    });
                    // 3. 执行导出函数，系统会弹出弹框
                    LAY_EXCEL.exportExcel(data, '现场科绩效统计.xlsx', 'xlsx');
                }
            });
        ...
        var tableInner = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'currency_string7', title: '采样简述', minWidth:100}
                ,{field: 'name', title: '采样员', minWidth:100}
        ...
        table.on('tool(table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){ //查看
                ...
                layer.open({
                    ...
                    +data.current_approvalCount+"&approver_count="+data.approver_count+"&approvalOpinion_type=58"//iframe的url
                });
                ...
                layer.open({
                    ...
                    maxmin: true,
                    area: ['30%', '40%'],
                    content: 'Currency/approvalOpinion.action?approval_id=58&currency_id='+data.currency_id
                });
            }
        });
