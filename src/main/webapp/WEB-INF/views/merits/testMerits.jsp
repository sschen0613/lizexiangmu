...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <button class="layui-btn layui-btn-xs" lay-event="add">检测科绩效申请单</button>
    </div>
</script>
...
<script>
    ...
    layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
        ...
        var tableInner = table.render({
            elem: '#tab'
            ,url: 'Currency/selectApplicantCurrency.action?currency_type=59' //数据接口
            ,page: true //开启分页
            ,toolbar: '#toolbarDemo'
            ,title: '检测科绩效申请'
// 			    	,totalRow: true //开启合计行
            ,cols: [[ //表头
                ...
                ,{field: 'currency_string7', title: '内容简述', minWidth:200}
            ...
            switch(obj.event){
                case 'add':
                    layer.open({
                        ...
                        maxmin: true,
                        area: ['80%', '80%'],
                        content: 'merits/testMeritsForm.action' //iframe的url
                    });
                    break;
                case 'delete':
                    layer.msg('删除');
