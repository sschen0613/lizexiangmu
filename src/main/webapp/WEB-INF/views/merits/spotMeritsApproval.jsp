...
<script>
    ...
    layui.use(['laydate', 'layedit', 'laypage', 'layer', 'table',  'element', 'form'], function(){
        ...
        form.on('submit(out)', function(data){
            ...
            var url = 'Currency/selectCurrencyApprover2.action?currency_type=58&currency_string='+staffid;
            if (date1 != null && date1 != ''){
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    data.unshift({
                        ...
                        currency_string7: '采样简述', details_int3:"检测类型", details_int4:"采样类型", details_money:"数量",
                        details_money2:"绩效金额",details_string11:"备注"
                    });
                    // 3. 执行导出函数，系统会弹出弹框
                    LAY_EXCEL.exportExcel(data, '现场科绩效.xlsx', 'xlsx');
                }
            });
